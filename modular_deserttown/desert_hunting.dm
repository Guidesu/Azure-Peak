...
/datum/hunting_category/desert_prey
	...
	animals = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mudcrab/cabbit = 30,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/saiga/game = 20
	)
	preferred_tracks = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mudcrab/cabbit = "small",
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/saiga/game = "hoof"
	)
...
/datum/hunting_category/desert_scavengers
	...
	animals = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/fox = 20,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/badger = 15,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/bobcat = 10,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mirespider = 15,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/bigrat = 20
	)
	preferred_tracks = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/fox = "canine",
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/badger = "small",
		...
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/bigrat = "small"
	)
	preferred_areas = list(
...
/datum/hunting_category/desert_predators
	...
	animals = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/hyena = 25,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/wolf = 15,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mirespider = 10, // Larger packs or tougher variants if possible, but rock spider fits
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mole = 5 // Rare sand mole
	)
	preferred_tracks = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/hyena = "canine",
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/wolf = "canine",
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mirespider = "small",
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mole = "large"
	)
	preferred_areas = list(
