...
/datum/hunting_category/desert_scavengers
	...
	animals = list(
		...
		/mob/living/simple_animal/hostile/retaliate/rogue/mirespider = 15,
...
/datum/hunting_category/desert_predators
	...
	animals = list(
		...
		/mob/living/simple_animal/hostile/retaliate/rogue/mirespider = 10, // Larger packs or tougher variants if possible, but rock spider fits
