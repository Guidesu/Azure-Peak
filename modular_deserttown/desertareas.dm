...
/area/rogue/outdoors/desert
	...
	ambush_mobs = list(
		...
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/raccoon = 25,
...
/area/rogue/outdoors/desertdeep
	...
	ambush_mobs = list(
		...
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/bigrat = 60,
		...
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/lamia = 10,
		/mob/living/carbon/simple_animal/hostile/rogue/dragger = 15,
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/spider/mutated = 15)
...
/area/rogue/under/desertdark
	...
	ambush_mobs = list(
				...
				/mob/living/carbon/simple_animal/hostile/retaliate/rogue/minotaur = 25,
				...
				/mob/living/carbon/simple_animal/hostile/retaliate/rogue/ooze_blob = 20
	)
