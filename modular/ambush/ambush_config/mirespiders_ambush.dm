...
/datum/ambush_config/mirespiders_ambush
	mob_types = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mirespider = 2,
		/mob/living/carbon/simple_animal/hostile/rogue/mirespider_lurker = 1
	)
...
/datum/ambush_config/mirespiders_crawlers
	mob_types = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mirespider = 4,
	)
...
/datum/ambush_config/mirespiders_aragn
	mob_types = list(
		/mob/living/carbon/simple_animal/hostile/retaliate/rogue/mirespider = 2,
		/mob/living/carbon/simple_animal/hostile/rogue/mirespider_paralytic = 1
	)
	threat_point = 2 * THREAT_TRASH + THREAT_ELITE
	faction_tag = "mirespiders"
