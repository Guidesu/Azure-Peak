...
/obj/item/reagent_containers/food/snacks/rogue/bun_marmalade
	...
	dish_type = DISH_BREAD
	name = "marmaladed bun"
	desc = "A delicious treat to bring along for those long-and-lonesome hikes through the outpost's forests; doubly-so, if you happen to be a tallow-coated wildkin of the urisine variety."
	icon = 'modular/Neu_Food/icons/cooked/cooked_baked.dmi'
...
/obj/item/reagent_containers/food/snacks/rogue/tomatoplate
	...
	name = "tomatoplate"
	desc = "A culinary delight from the outpost's shores, purported to've originated from an inflow of Etruscean refugees from long ago. The \
...
/obj/item/reagent_containers/food/snacks/rogue/peartomatoplate
	...
	desc = "A curious spin on a local classic, attributed to the hands of Vanderlin's most esteemed culinarians. The \
...
/obj/item/reagent_containers/food/snacks/rogue/lasagna_pesto
	...
	name = "pesto lasagna"
	desc = "Pasta sheets elegantly stacked with pesto neatly spread between. It's taste can only be described as 'zig-like', the rocknut in the pesto seeming to boil from the heat. This version is even more loved by local nobles, though visiting Montecarinan signoria-bloods are known occasionally to be offended at the taste."
	icon = 'modular/Neu_Food/icons/cooked/cooked_pasta.dmi'
