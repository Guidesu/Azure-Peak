...
/obj/item/reagent_containers/food/snacks/fish/clownfish
	name = "clownfish"
	desc = "This fish brings vibrant hues to the dark world of the outpost."
...
/obj/item/reagent_containers/food/snacks/fish/creepy_squid/examine(mob/user)
	...
	if(ishuman(H) && !HAS_TRAIT(H, TRAIT_NOMOOD) && H.patron.type != /datum/patron/concordat/wulfric)
		...
		H.emote("scream")
		H.Knockdown(1)
	else if(H.patron.type == /datum/patron/concordat/wulfric)
