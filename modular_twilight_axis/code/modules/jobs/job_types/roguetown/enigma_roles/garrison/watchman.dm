/datum/job/roguetown/town_watch
	...
	tutorial = "Answering for the safety of the city and the enforcement of the law, you walk among the oppressed, delivering justice and pain. \
	Perhaps you even witnessed the DISAPPEARANCE of the Baron and the hasty arrival of the King with his retinue, who came to take over and immediately seized power in the city. \
	Or perhaps you heard from your old comrades-in-arms less than flattering words about the King, for the power and authority of the Watch have noticeably\
	diminished since His arrival.\
	Be that as it may, your loyalty belongs to the missing Baron, the TRUE lord of this city, to the townsfolk, \
	and only then to the King and his retinue, who still refuse to leave their temporary seat. \
	And how will this vaunted Royal Guard protect the people of Rockhill, sitting in the castle, if not for you?"
	whitelist_req = TRUE
...
/datum/advclass/town_watch/dungeoneer
	name = "Dungeoneer"
	tutorial = "Repentance, a vile inclination toward sadism, or a twisted understanding of justice - something among these led you to don the despised hood of an executioner.\
	\ The whims of the sheriff and the nobility are your law; you are not one to agonize over questions of morality."
