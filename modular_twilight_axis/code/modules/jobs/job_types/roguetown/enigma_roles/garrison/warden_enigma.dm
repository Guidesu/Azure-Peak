/datum/job/roguetown/overseer
	...
	tutorial = "As an experienced soldier from His Majesty's retinue, you have been tasked with overseeing the recently constructed Bastion. \
				You answer to the marshal and his advisors, \
				and your duty is to keep the vanguard in formation and ensure the roads to the city remain safe. \
...
/obj/item/clothing/suit/roguetown/armor/plate/cuirass/overseer
	...
	desc = "A light armor of the Vanguard overseer, dyed in distinctive black colors. 'O King of these lands, those who fall today honor you.'"
