/datum/job/roguetown/royal_sergeant
	...
	tutorial = "For most of your life you served in His Majesty's life guards, and you were honored with the greatest privilege of leading your comrades into battle for the glory of the Crown, \
	though your primary duty is to protect the palace, the royal family, and his retinue on this cursed island.  \
	The local fools still believe the Baron is ALIVE, when you know full well that he is DEAD, there is no other way. \
	Your duty is to prevent the Royal dynasty from falling, in the name of Enigma's future."
