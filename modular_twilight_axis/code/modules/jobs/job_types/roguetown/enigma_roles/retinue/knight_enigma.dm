/datum/job/roguetown/knight_enigma
	...
	Your valor and martial skills were noticed long ago by the crown, and now you are honored with the greatest privilege - to stand beside the King. \
	For 12 years now you have defended him in this cursed barony. You can rely on no one but yourself, the King, the marshal, \
	and the royal guard, for beyond the castle walls there are only toothless peasants and fools who blindly deny the Baron's death."
