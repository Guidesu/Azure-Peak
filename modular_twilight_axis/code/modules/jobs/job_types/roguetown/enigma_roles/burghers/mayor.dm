/datum/job/roguetown/mayor
	...
	tutorial = "Mired in corruption or a great benefactor, perhaps something in between - you are the mayor of the city of Rockhill and enjoy the respect and honor of its residents. \
	In these difficult times, the burden of governing the city has fallen upon you, and it is to you that trusting townsfolk turn for help and advice. \
	12 years have passed since the baron died under mysterious circumstances, and in his place the King and his retinue settled in the castle. The Kingdom of Enigma worsens with each passing year. \
	Let the King rule over all of you, but perhaps it is time to change something?"
...
/obj/effect/proc_holder/spell/self/writeresidentscroll/cast(list/targets, mob/living/user = usr)
	...
	if(!resident_manuscripts_enabled())
		to_chat(user, span_warning("Resident certificates are temporarily unavailable on this map."))
		revert_cast()
		return
