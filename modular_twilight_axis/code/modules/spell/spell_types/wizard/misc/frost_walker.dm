...
/obj/effect/proc_holder/spell/self/frost_walker
	name = "Frost Walker"
	desc = "Freezes water. Drains stamina. Automatically deactivates when exhausted."
...
/obj/effect/proc_holder/spell/self/frost_walker/charge_check(mob/user) //stub for offcode
	if(active)
		return TRUE
