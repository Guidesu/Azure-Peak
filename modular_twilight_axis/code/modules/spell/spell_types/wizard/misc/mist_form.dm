...
//obj/effect/proc_holder/spell/self/mist_form/cast(list/targets, mob/living/user = usr) The mist form effect now needs to be toggled off manually. If you want to bring the spell back into the game, implement the buff deactivation.
