...
/proc/resident_manuscript_place_resident_in_tavern(mob/living/carbon/human/recipient)
	...
	if(length(possible_chairs))
		...
		to_chat(recipient, span_notice("As a town resident, you find yourself on a chair in the local tavern."))
		return
	...
	if(length(possible_spawns))
		...
		to_chat(recipient, span_notice("As a town resident, you find yourself in the local tavern."))
