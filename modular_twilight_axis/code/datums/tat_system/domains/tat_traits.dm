...
/datum/tat_traits/proc/get_trait_conflict_map()
	...
	GLOB.tat_trait_conflict_map = list(
		...
		TRAIT_LONGSWORDSMAN = list(TRAIT_SABRIST),
		TRAIT_SABRIST = list(TRAIT_LONGSWORDSMAN),
		TRAIT_IGNORESLOWDOWN = list(TRAIT_IGNOREDAMAGESLOWDOWN),
		TRAIT_IGNOREDAMAGESLOWDOWN = list(TRAIT_IGNORESLOWDOWN),
		TRAIT_LEECHIMMUNE = list(TRAIT_LEECHRESIST),
		TRAIT_LEECHRESIST = list(TRAIT_LEECHIMMUNE)
	)
	return GLOB.tat_trait_conflict_map
