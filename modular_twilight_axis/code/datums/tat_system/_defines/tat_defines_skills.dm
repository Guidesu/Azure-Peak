#define TAT_SKILL_COMBAT_CAP_DEFAULT 2
#define TAT_SKILL_COMBAT_CAP_WEAPON_TRAINED 3
...
#define TAT_COMBAT_CONVERTED_POINT_LIMIT 3
#define TAT_TRAIT_WARRIOR_EXPERT_COMBAT_POINTS 6
...
#define TAT_DEFAULT_SKILL_DOMAIN_POINTS list( \
	TAT_SKILL_DOMAIN_COMBAT = 60, \
	TAT_SKILL_DOMAIN_LABOUR = 60, \
	TAT_SKILL_DOMAIN_MISC = 60 \
)
...
#define TAT_VIRTUE_CHOICE_COMBAT_SWORDS "Sword Skill (JMAN)"
