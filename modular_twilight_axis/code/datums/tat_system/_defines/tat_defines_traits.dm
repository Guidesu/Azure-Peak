...
#define TAT_TRAIT_FREE_SOUL_RENAME "tat_free_soul_rename"
...
// Legacy virtues are now exposed through TAT-owned entries. The stable prefix
// keeps serialized trait ids independent of the old Character Sheet UI.
#define TAT_TRAIT_VIRTUE_PREFIX "tat_virtue_"
...
#define TAT_TRAIT_RANGED_SUPPLIER "tat_ranged_supplier"
#define TAT_TRAIT_RANGED_SYNERGY_BOWS "tat_ranged_synergy_bows"
...
#define TAT_TRAIT_POLYGLOT "tat_polyglot"
...
#define TAT_VIRTUE_CHOICE_TRAIT_RULES list( \
	/datum/virtue/utility/skilled = list( \
		TAT_VIRTUE_CHOICE_SKILLED_BSMITH = list(TRAIT_SMITHING_EXPERT), \
		TAT_VIRTUE_CHOICE_SKILLED_TAILOR = list(TRAIT_SEWING_EXPERT), \
		TAT_VIRTUE_CHOICE_SKILLED_HUNTER = list(TRAIT_SURVIVAL_EXPERT, TRAIT_MASTERFUL_HUNTER), \
		TAT_VIRTUE_CHOICE_SKILLED_PHYS = list(TRAIT_MEDICINE_EXPERT, TRAIT_ALCHEMY_EXPERT), \
		TAT_VIRTUE_CHOICE_SKILLED_ARTIF = list(TRAIT_SMITHING_EXPERT), \
		TAT_VIRTUE_CHOICE_SKILLED_ENCHANT = list(TRAIT_ENCHANTING_EXPERT, TRAIT_ALCHEMY_EXPERT, TRAIT_ARCYNE) \
	), \
	/datum/virtue/utility/apprentice = list( \
		TAT_VIRTUE_CHOICE_APPRENTICE_MINING = list(TRAIT_SMITHING_EXPERT) \
	) \
)
...
// TAT_TRAIT_CONTRACTOR = TAT_TRAIT_ENTRY("Contractor", 80, "Awakens the contract-bearing curse in your veins. The whole world is waiting your gifts and deals."),
#define TAT_AVAILABLE_TRAITS_LIST \
	TAT_TRAIT_SPELLBLADE = TAT_TRAIT_ENTRY("Spellblade", 2, "Grants weapon-binding spells, +2 Arcyne Armament, and +3 Arcana. Characters can raise Arcana to Master."), \
	...
	TAT_TRAIT_TRADER_LICENSE = TAT_TRAIT_ENTRY("Merchant License", 1, "Unlocks sealed trader caches in the TAT item list."), \
	...
	TAT_TRAIT_BARDIC_INSPIRATION_T2 = TAT_TRAIT_ENTRY("Bardic Inspiration II", 2, "Upgrades bardic inspiration to tier 2, increasing audience size and songs known."), \
	TAT_TRAIT_PARTY_LEADER = TAT_TRAIT_ENTRY("Party Leader", 2, "Improves the core Fellowship: nearby fellows gain +1 CON; while at least one fellow is nearby, the leader gains +1 CON, +1 WIL, and +0.5 Fortune per nearby fellow."), \
	TAT_TRAIT_BONUS_STAT_POOL = TAT_TRAIT_ENTRY("Natural Potential", 2, "Shenanigans only. Requires Melee 2 and grants +3 stat points."), \
	...
	TAT_TRAIT_BODYBUILDER_SKIN = TAT_TRAIT_ENTRY("Bodybuilder Skin", 2, "available to all. Starts you with pit-hardened regenerating skin equipped in the armor slot. Does not require Enduring. Conflicts with other skin traits."), \
	...
	TRAIT_OUTDOORSMAN = TAT_TRAIT_ENTRY("Outdoorsman", 3, "Experience in the wilds lets you sleep on surfaces like treebranches as if they were beds. Costs 1 Survival point."), \
	TRAIT_CIVILIZEDBARBARIAN = TAT_TRAIT_ENTRY("Expert Pugilist", 2, "Turns you into a living weapon: stronger unarmed strikes, broader unarmed reach, and much better parrying with bracers, knuckles, or bandages. Characters with Expert Warrior can raise Unarmed to level 5; Wrestling is not raised by this special unlock."), \
	...
	TAT_TRAIT_STEEL_SUPPLIER = TAT_TRAIT_ENTRY("Steel Supplier", 2, "Unlocks steel-tier weapons."), \
	TAT_TRAIT_RANGED_SUPPLIER = TAT_TRAIT_ENTRY("Ranged Supplier", 1, "Unlocks the ranged supply branch for bows, crossbows, slings and their munitions."), \
	TAT_TRAIT_LEATHER_SUPPLIER = TAT_TRAIT_ENTRY("Leather Supplier", 1, "Unlocks leather gear in all supported slots. Synergy: with Survival 3, leather gear costs 50% less."), \
	TAT_TRAIT_MAIL_SUPPLIER = TAT_TRAIT_ENTRY("Maille Supplier", 1, "Unlocks maille gear in all supported slots. Synergy: with Maille Training, maille gear costs 50% less."), \
	TAT_TRAIT_PLATE_SUPPLIER = TAT_TRAIT_ENTRY("Plate Supplier", 1, "Unlocks plate gear in all supported slots. Synergy: with Plate Training, plate gear costs 50% less."), \
	TRAIT_INTELLECTUAL = TAT_TRAIT_ENTRY("Intellectual", 1, "You have a keen eye and can assess a person's prowess in wit and blade."), \
	...
	TRAIT_SEEPRICES = TAT_TRAIT_ENTRY("Appraiser", 1, "You can tell the prices of things down to the zenny."), \
	TRAIT_OUTLANDER = TAT_TRAIT_ENTRY("Outlander", -2, "The locals see you as not of their land."), \
	...
	TAT_TRAIT_WITCH_INITIATE = TAT_TRAIT_ENTRY("Witch Initiate", 2, "Grants witch trait, deathsight, and ability to shapeshift yourself into different small creatures. available to all: Magic 2 unlocks Old Magick, Miracles 2 unlocks Godsblood, and Magic 1 plus Miracles 1 unlocks Mystagogue."), \
	...
	TAT_TRAIT_HUNTER_BEATER = TAT_TRAIT_ENTRY("Beater Hunter", 2, "Hunter path. Polearms cost 1 less to raise. Melee direction keeps standard battle progression, but each new level costs 1 less to a minimum of 1. Conflicts with Shooter Hunter and major peaceful specializations."), \
	TAT_TRAIT_HUNTER_SHOOTER = TAT_TRAIT_ENTRY("Shooter Hunter", 2, "Hunter path. Bows, crossbows and slings can be raised to level 4. Ranged direction keeps standard battle progression, but each new level costs 1 less to a minimum of 1. Conflicts with Beater Hunter and major peaceful specializations."), \
	...
	TAT_TRAIT_TRAINEE_SMITH = TAT_TRAIT_ENTRY("Trainee Smith", 1, "Reduces the cost of Blacksmithing, Smelting, and the first two levels of Maces by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_ARMORER = TAT_TRAIT_ENTRY("Trainee Armorer", 1, "Reduces the cost of Armorsmithing, Masonry, and the first two levels of Shields by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_WEAPONSMITH = TAT_TRAIT_ENTRY("Trainee Weaponsmith", 1, "Reduces the cost of Weaponsmithing, Engineering, and the first two levels of Swords by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_WOODSMAN = TAT_TRAIT_ENTRY("Trainee Woodsman", 1, "Reduces the cost of Lumberjacking, Carpentry, and the first two levels of Axes by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_SURVIVALIST = TAT_TRAIT_ENTRY("Trainee Survivalist", 1, "Reduces the cost of Butchering, Hunting, and the first two levels of Archery by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_POACHER = TAT_TRAIT_ENTRY("Trainee Poacher", 1, "Reduces the cost of Tracking, Trapmaking, and the first two levels of Crossbows by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_SKULKER = TAT_TRAIT_ENTRY("Trainee Skulker", 1, "Reduces the cost of Sneaking, Lockpicking, and the first two levels of Knives by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_VAGABOND = TAT_TRAIT_ENTRY("Trainee Vagabond", 1, "Reduces the cost of Pickpocketing, Climbing, and the first two levels of Slings by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_RIDER = TAT_TRAIT_ENTRY("Trainee Rider", 1, "Reduces the cost of Riding, Athletics, and the first two levels of Polearms by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_MARINER = TAT_TRAIT_ENTRY("Trainee Mariner", 1, "Reduces the cost of Swimming, Fishing, and the first two levels of Staves by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_CLOTHIER = TAT_TRAIT_ENTRY("Trainee Clothier", 1, "Reduces the cost of Sewing, Skincrafting, and the first two levels of Whips & Flails by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_HOMESTEADER = TAT_TRAIT_ENTRY("Trainee Homesteader", 1, "Reduces the cost of Farming, Cooking, and the first two levels of Wrestling by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_ARTISAN = TAT_TRAIT_ENTRY("Trainee Artisan", 1, "Reduces the cost of Crafting, Pottery, and the first two levels of Unarmed by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_CHIRURGEON = TAT_TRAIT_ENTRY("Trainee Chirurgeon", 1, "Reduces the cost of Medicine, Literacy, and the first two levels of Staves by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_TRAINEE_TROUBADOUR = TAT_TRAIT_ENTRY("Trainee Troubadour", 1, "Reduces the cost of Music, Literacy, and the first two levels of Knives by 1. Does not stack with other discount traits on the same skill."), \
	TAT_TRAIT_MASTER_OF_CRAFTING = TAT_TRAIT_ENTRY("Master of Handicraft", 2, "Grants +30 labour skill points. Costs 2 Skills points; Players get the first Handicraft/Straying Soul trait free, Players always pay 1."), \
	TAT_TRAIT_HANDICRAFT_APPRENTICE = TAT_TRAIT_ENTRY("Handicraft Apprentice", 1, "available to all. Grants +15 labour skill points and conflicts with Master of Handicraft."), \
	...
	TRAIT_ALCHEMY_EXPERT = TAT_TRAIT_ENTRY("Expert Alchemist", 2, "Deep, intricate knowledge of the alchemical arts. Alchemy can progress to Legendary levels."), \
	TAT_TRAIT_SKILLED_ALCHEMIST = TAT_TRAIT_ENTRY("Skilled Alchemist", 1, "Skilled with alchemical work. Alchemy can be picked to Master levels."), \
	TRAIT_MEDICINE_EXPERT = TAT_TRAIT_ENTRY("Expert Physicker", 2, "Deep, intricate knowledge of medicine. Medicine can progress to Legendary levels."), \
	TAT_TRAIT_SKILLED_PHYSICKER = TAT_TRAIT_ENTRY("Skilled Physicker", 1, "Skilled with medical practice. Medicine can be picked to Master levels."), \
	TRAIT_HOMESTEAD_EXPERT = TAT_TRAIT_ENTRY("Expert Homesteader", 3, "Experienced with the arts of homesteading. Farming, Mining, Cooking, Fishing, Butchering, Lumberjacking, Masonry and Pottery can progress to Legendary levels. Sewing and Skincrafting can progress to Journeyman levels."), \
	TRAIT_SELF_SUSTENANCE = TAT_TRAIT_ENTRY("Self-Sustenance", 2, "Years of running from the law and living off the land have made you a jack of all trades. All crafting and labor skills can progress to Journeyman levels."), \
	TRAIT_SURVIVAL_EXPERT = TAT_TRAIT_ENTRY("Expert Survivalist", 2, "Experienced with survival in the wild. Cooking, Fishing, Butchering and Skincrafting can progress to Legendary levels. Sewing can progress to Journeyman levels."), \
	TAT_TRAIT_SKILLED_SURVIVALIST = TAT_TRAIT_ENTRY("Skilled Survivalist", 1, "Skilled with survival work. Butchering, Trapmaking and Skincrafting can be picked to Master levels."), \
	TRAIT_SEWING_EXPERT = TAT_TRAIT_ENTRY("Expert Clothier", 2, "Experienced with sewing and leathercraft. Sewing, Skincrafting and Butchering can progress to Legendary levels."), \
	TAT_TRAIT_SKILLED_CLOTHIER = TAT_TRAIT_ENTRY("Skilled Clothier", 1, "Skilled with cloth and leather. Sewing and Skincrafting can be picked to Master levels."), \
	TRAIT_SEEDKNOW = TAT_TRAIT_ENTRY("Seed Knower", 1, "You know which seeds grow which crops."), \
	TRAIT_CAUTIOUS_FISHER = TAT_TRAIT_ENTRY("Cautious Fisher", 1, "You know the dangers of fishing and how to avoid unwanted attention from the depths."), \
	TRAIT_SQUIRE_REPAIR = TAT_TRAIT_ENTRY("Squire Knowledge", 1, "You can restore gear with time and polish it until it gleams like new."), \
	...
	TAT_TRAIT_STRAYING_SOUL = TAT_TRAIT_ENTRY("Straying Soul", 2, "Grants +21 misc skill points. Costs 2 Skills points; Players get the first Handicraft/Straying Soul trait free, Players always pay 1."), \
	TAT_TRAIT_STRAYING_SOUL_APPRENTICE = TAT_TRAIT_ENTRY("Straying Soul Apprentice", 1, "available to all. Grants +10 misc skill points and conflicts with Straying Soul."), \
	...
	TAT_TRAIT_HERETIC = TAT_TRAIT_ENTRY("Heretic", 0, "Gain cool HERETIC mark on your face. Characters gain the mark and cannot use it to unlock Ritualist, Berserkers Rage, or bypass defensive divine lockouts."), \
	...
	TRAIT_NUDE_SLEEPER = TAT_TRAIT_ENTRY("Nude Sleeper", -1, "You can only sleep while fully naked."), \
	...
	TRAIT_ZJUMP = TAT_TRAIT_ENTRY("High Jumping", 1, "You can jump to greater heights, reaching places others cannot."), \
	TRAIT_LEAPER = TAT_TRAIT_ENTRY("Leaper", 2, "You can leap like a frog, landing exactly where you want."), \
	TRAIT_NUTCRACKER = TAT_TRAIT_ENTRY("Nutcracker", 1, "Your kicks to the groin are devastatingly effective."), \
	TRAIT_SEEPRICES_SHITTY = TAT_TRAIT_ENTRY("Shabby Appraiser", 1, "You can tell the prices of things... kind of."), \
	TRAIT_STRONGBITE = TAT_TRAIT_ENTRY("Strong Bite", 1, "Your bites are stronger and can perform critical bite attacks."), \
	TRAIT_STRONGKICK = TAT_TRAIT_ENTRY("Strong Kick", 1, "Your kicks knock people down and back a step, consistently."), \
	TRAIT_NOBLE = TAT_TRAIT_ENTRY("Noble Blooded", 2, "You are of noble blood, recognized by those who know the old families."), \
	TRAIT_BREADY = TAT_TRAIT_ENTRY("Battleready", 1, "Defensive stance does not passively fatigue you. You regain energy slowly over time."), \
	TRAIT_ARMOUR_LIKED = TAT_TRAIT_ENTRY("Fitting Armour", 1, "You're wearing something more suited to your style."), \
	TRAIT_SKILLBLESSED = TAT_TRAIT_ENTRY("Skill Blessed", 2, "You've reunited with an old friend. All is well."), \
	...
	TRAIT_ARMOR_NOSPDCAP = TAT_TRAIT_ENTRY("Armour Unburdened", 2, "You are the armour, and the armour is free. You move like water, and it moves with you. No speed penalty from any armour."), \
	...
	TRAIT_RAGE = TAT_TRAIT_ENTRY("Rage", 2, "Pain and injury fuels your battlerage!"), \
	TRAIT_WILD_EATER = TAT_TRAIT_ENTRY("Beastly Digestion", 1, "You can eat raw food and drink from dirty water."), \
	TRAIT_INSPIRING_MUSICIAN = TAT_TRAIT_ENTRY("Inspiring Musician", 2, "The flow of battle dances to your song! Unlocks bardic inspiration abilities."), \
	TRAIT_NOFALLDAMAGE1 = TAT_TRAIT_ENTRY("Fall Damage Reduction", 1, "You can easily handle minor falls."), \
	TRAIT_NOFALLDAMAGE2 = TAT_TRAIT_ENTRY("Fall Damage Immunity", 2, "You can handle a fall from any height."), \
	...
	TRAIT_FASTSLEEP = TAT_TRAIT_ENTRY("Fast Sleeper", 1, "You fall asleep faster than most."), \
	TRAIT_POLYTHEIST = TAT_TRAIT_ENTRY("Polytheist", 1, "You worship multiple gods of the pantheon."), \
	TRAIT_MONOTHEIST = TAT_TRAIT_ENTRY("Monotheist", 1, "You worship a single god above all others."), \
	TRAIT_GUARDSMAN = TAT_TRAIT_ENTRY("Vigilant Guardsman", 1, "You are vigilant in your duties. In the streets of the outpost, your abilities are sharper due to your routine and familiarity."), \
	TRAIT_TAVERN_FIGHTER = TAT_TRAIT_ENTRY("Tavern Fighter", 1, "You are vigilant in your duties. The Tavern is your home, none shall dare oppose me or skip out on payment."), \
	TRAIT_WOODSMAN = TAT_TRAIT_ENTRY("Talented Woodsman", 1, "You are vigilant in your duties. In the grove and coast surrounding the outpost, your abilities are sharper due to your routine and familiarity."), \
	TRAIT_ANTHRAXI = TAT_TRAIT_ENTRY("Apex Predator", 2, "You are the deadliest being in the underdark. No beast or foe can ever hope to match you in the caves."), \
	TRAIT_MARRIAGE_CAPABLE = TAT_TRAIT_ENTRY("Marriage Capable", 1, "By the favor of the gods, you can perform the rite of marriage."), \
	TRAIT_INQUISITION = TAT_TRAIT_ENTRY("Otavan Adherent", 1, "You serve the Tribunal's Inquisition. From a passing glance, you can recognize all other adherents within the local sect."), \
	TRAIT_CLERGY = TAT_TRAIT_ENTRY("Clergy of the Concordat", 1, "You serve the Church of the Concordat. From a passing glance, you can recognize all other clergy of this Church."), \
	TRAIT_GOODTRAINER = TAT_TRAIT_ENTRY("Good Trainer", 1, "You are a good teacher, and when it comes to weaponry you can train others to be just as skilled as you are."), \
	TRAIT_BADTRAINER = TAT_TRAIT_ENTRY("Bad Trainer", -1, "You've spent yils studying the art of a single weapon, but unfortunately you've no patience to train anyone else. Everyone learning from you will only learn up to two skill levels below yours."), \
	TRAIT_SEA_DRINKER = TAT_TRAIT_ENTRY("Denizen of the Deep", 1, "As a denizen of the deep, you can drink salty ocean water safely."), \
	TRAIT_STUDENT = TAT_TRAIT_ENTRY("Student", 1, "You are overwhelmed by all this knowledge! Eager to learn."), \
	TRAIT_PURITAN = TAT_TRAIT_ENTRY("Otavan Emissary", 2, "You are an emissary of the Holy Otavan Inquisition, and the one who shepherds the local sect. With a silver psycross, you can force restrained heathens to kneel before a crucifix and proclaim their true allegiance."), \
	TRAIT_ARTILLERY_EXPERT = TAT_TRAIT_ENTRY("Artillery Expert", 1, "You are trained in the safe handling of gunpowder and firearms, reducing mishap risk."), \
	TRAIT_DEATHBYSNUSNU = TAT_TRAIT_ENTRY("Bed Breaker", 1, "Your pelvis is crushing and you cause increased pain in intimate encounters."), \
	TRAIT_DREAMWALKER = TAT_TRAIT_ENTRY("Dreamwalker", 2, "You walk the dream and reality at the same time. Your mind frays, but your vision shall be reality."), \
	TRAIT_ROYALSERVANT = TAT_TRAIT_ENTRY("Household Insight", 1, "You've been serving the royal family for long enough to know their exotic tastes. You can see the royals' liked and hated food and drink."), \
	...
	TRAIT_STANDARD_BEARER = TAT_TRAIT_ENTRY("Standard Bearer", 1, "The banner is your lifeline. The retinue know to rally around you, so long as you keep it safe."), \
	TRAIT_VENDETTA = TAT_TRAIT_ENTRY("Vendetta", 1, "You are locked in a vendetta, allowing for clashing in the combat system similar to Duelist Rings."), \
	TRAIT_FEYTOUCHED = TAT_TRAIT_ENTRY("Feytouched", 1, "You've been influenced or created by fey. After offering lux to a heartroot, you can use it to travel."), \
	TRAIT_ROOT_WALKER = TAT_TRAIT_ENTRY("Root Walker", 1, "After offering lux, you can travel along heartroot trees."), \
	TRAIT_WYRD_LABOURER = TAT_TRAIT_ENTRY("Wyrd Labourer", 1, "Strange power causes your swings to cut through trees and rocks with ease."), \
	TRAIT_PERFECT_TRACKER = TAT_TRAIT_ENTRY("Huntmaster", 2, "You are a master at pursuing those you hunt. You can discern every last detail within a spotted track, and any attempts to hide said-tracks will fail to deceive you."), \
	TRAIT_ZIZOSIGHT = TAT_TRAIT_ENTRY("Blessing of Aurelian", 1, "Aurelian blesses your eyes to be unburdened by the night. You can also somewhat judge if a corpse can be reanimated or not."), \
	TRAIT_DEATHSIGHT = TAT_TRAIT_ENTRY("Veiled Whispers", 1, "You can feel when someone nearby draws the Undermaiden's attention."), \
	TRAIT_WATERBREATHING = TAT_TRAIT_ENTRY("Water Breathing", 2, "You do not drown in bodies of water."), \
	TRAIT_NALEDI = TAT_TRAIT_ENTRY("Naledi Complex", 1, "You hail from the lands of Naledi. Your blood and knowledge are storied in yils of texts and techniques. Your birthright is your pride."), \
	TRAIT_JAILOR = TAT_TRAIT_ENTRY("Gnarly Jailor", 1, "You are the ducal torturer and executioner. Society looks down upon you and you will never be graced by loving touch of the Gods."), \
	TRAIT_HONORBOUND = TAT_TRAIT_ENTRY("Honorbound Tattoos", 2, "The Tattoos of this Clan bind you to a lifestyle of bare-skinned battle and swordsmanship. You refuse to wear armor that does not compliment your traditional garb and tattoos."), \
	TRAIT_DRUG_SUPPLY = TAT_TRAIT_ENTRY("Drug Supply", 1, "The Guild keeps you supplied. You get a fresh drug delivery from HERMES each day."), \
	TRAIT_BOMBER_EXPERT = TAT_TRAIT_ENTRY("Explosive Specialist", 1, "You are a trained expert in explosives, capable of crafting and handling them with greater safety."), \
	TRAIT_TOLERANT = TAT_TRAIT_ENTRY("Tolerant", 1, "You dream of an ideal future, one with peace between all races."), \
	TRAIT_DUNGEONMASTER = TAT_TRAIT_ENTRY("Ruthless Jailor", 1, "You are a ruthless jailor, skilled in the arts of confinement and interrogation."), \
	TRAIT_FROZEN_STAMINA = TAT_TRAIT_ENTRY("Frozen Stamina", 1, "Your stamina is frozen — it does not drain passively."), \
	TRAIT_LIGHT_STEP = TAT_TRAIT_ENTRY("Light Step", 1, "Your steps are light and swift. You make less noise while sneaking and wearing armor, and can sneak much quicker."), \
	TRAIT_DARKVISION = TAT_TRAIT_ENTRY("Darksight", 1, "You can see better in the dark."), \
	TRAIT_DUALWIELDER = TAT_TRAIT_ENTRY("Dual Wielder", 2, "While wielding two one-hand weapons with at least Journeyman skill on each, you alternate attacks between them. After 4 strikes, you'll attack with both at once. Your parry and dodge are reduced by 5% while holding two weapons."), \
	TRAIT_SHARPER_BLADES = TAT_TRAIT_ENTRY("Sharper Blades", 1, "Your blades go dull slower, ensuring they stay sharp longer."), \
	...
	TRAIT_BOGWALKER = TAT_TRAIT_ENTRY("Bogwalker", 1, "The bog's blessing graces you. Kneestingers and leeches will not harm you, and you cannot trigger ambushes within the bog unless sprinting."), \
	TRAIT_NATIVEBORN = TAT_TRAIT_ENTRY("Native Born", 1, "You've grown up and lived all your life in these lands. You can only trigger ambushes if you sprint through them."), \
	TRAIT_SLEUTH = TAT_TRAIT_ENTRY("Sleuth", 1, "You can spot your tracked Mark's trail without needing to approach it, and can spot them at a distance. You can track more frequently, and the act is not impaired by movement."), \
	TRAIT_WOODWALKER = TAT_TRAIT_ENTRY("Woodwalker", 1, "You can climb trees quicker, and gain climbing experience twice as quickly. You can step on thorns and branches safely in the woods."), \
	TRAIT_CAVEDWELLER = TAT_TRAIT_ENTRY("Cave Dweller", 1, "The mountains are your home. You prefer to live beneath the surface away from the sun's gaze and know the caves of this land like the back of your hand."), \
	TRAIT_NIGHT_OWL = TAT_TRAIT_ENTRY("Night Owl", 1, "You enjoy spending your time in the night."), \
	TRAIT_BEAUTIFUL = TAT_TRAIT_ENTRY("Beautiful", 2, "People love looking at your face."), \
	TRAIT_DETACHED = TAT_TRAIT_ENTRY("Detached", 1, "Nothing could move you. Any emotion you show is a facade."), \
	TRAIT_EQUESTRIAN = TAT_TRAIT_ENTRY("Equestrian", 1, "You are a capable rider. Your mount is an extension of you."), \
	TRAIT_COMBAT_AWARE = TAT_TRAIT_ENTRY("Combat Aware", 1, "Your honed senses and intuition allow you to spot notable things in the midst of battle with ease."), \
	TRAIT_TEMPO = TAT_TRAIT_ENTRY("Tempo Capable", 2, "You can keep up with multiple opponents at once."), \
	TRAIT_BLACKBAGGER = TAT_TRAIT_ENTRY("Skilled Apprehender", 1, "You've been trained to properly abduct individuals through the use of garrotes and blackbags."), \
	TRAIT_ADRENALINE_RUSH = TAT_TRAIT_ENTRY("Adrenaline Rush", 1, "You're invigorated in the midst of battle! You don't feel your wounds!"), \
	TRAIT_BETTER_SLEEP = TAT_TRAIT_ENTRY("Better Sleep", 1, "You recover more energy when sleeping."), \
	TRAIT_FORTITUDE = TAT_TRAIT_ENTRY("Fortitude", 1, "The typical drain you feel from day to day life is lessened, your athleticism greater."), \
	TRAIT_SELF_RELIANCE = TAT_TRAIT_ENTRY("Self-Reliance", 2, "You've spent enough time standing on your own that you've learned to either adapt or die young. All crafting and labor skills can progress to Journeyman levels."), \
	TRAIT_LEYLINE_ATTUNEMENT = TAT_TRAIT_ENTRY("Leyline Attunement", 2, "You are attuned to the leylines, allowing you to imbue enchantments into objects."), \
	...
	TRAIT_BASHDOORS = TAT_TRAIT_ENTRY("Door Basher", 1, "You can bash through doors with your sheer strength."), \
	...
	TRAIT_SENTINELOFWITS = TAT_TRAIT_ENTRY("Sentinel of Wits", 2, "Your Intelligence aids in your defense. Every 2 points above 10 INT become an additional 10% chance to dodge or parry."), \
	TRAIT_MUSES_GRACE = TAT_TRAIT_ENTRY("Muses Grace", 1, "You feel a sudden and powerful urge to break out into song."), \
	TRAIT_CURSE_RESIST = TAT_TRAIT_ENTRY("Curse Resistance", 1, "You have a tendency to resist curses placed upon you."), \
	TRAIT_NOPAIN = TAT_TRAIT_ENTRY("Painless", 3, "You feel no pain at all. You can endure any amount of punishment before collapsing."), \
	TRAIT_TOXIMMUNE = TAT_TRAIT_ENTRY("Poison Immune", 3, "Poisons do nothing to you."), \
	TRAIT_GRABIMMUNE = TAT_TRAIT_ENTRY("Unstoppable", 3, "Your great strength, or slippery agility, prevents others from getting ahold of you."), \
	...
	TRAIT_NOLIMBDISABLE = TAT_TRAIT_ENTRY("No Limb Disable", 3, "Your limbs cannot be disabled in combat."), \
	TRAIT_STRENGTH_UNCAPPED = TAT_TRAIT_ENTRY("Strength Unbound", 3, "Your strength is unbound! You ignore the STR softcap."), \
	TRAIT_BATTLEMASTER = TAT_TRAIT_ENTRY("Battlemaster", 3, "You can use special attacks of any weapon without needing to be trained in it."), \
	TRAIT_NITEVISION = TAT_TRAIT_ENTRY("Nitevision", 2, "You can see perfectly in the dark."), \
	TRAIT_LEYLINE_HASTE = TAT_TRAIT_ENTRY("Leyline's Clarity", 3, "You can fully see and use the threads which bind the world together! Spell casting time and cooldowns are 25% faster."), \
	TRAIT_SWIFTCAST = TAT_TRAIT_ENTRY("Spell Acceleration", 3, "You are magically accelerating your words of power and evocations! You can instantly cast a spell."), \
	TRAIT_COUNTERCOUNTERSPELL = TAT_TRAIT_ENTRY("Counter Counterspell", 2, "You automatically know when to counter Counterspells, and can do so without even thinking about it."), \
	TRAIT_REGROW_LIMBS = TAT_TRAIT_ENTRY("Regrow Limbs", 3, "You can regrow your limbs in your sleep, but doing so will make you hungry."), \
	TRAIT_LYCANRESILENCE = TAT_TRAIT_ENTRY("Werewolf Resilience", 3, "Your wounds regenerate over time."), \
	TRAIT_VAELTITE = TAT_TRAIT_ENTRY("Praecursory Devotion", 3, "You passively recover from most injuries over time, so long as you are not bled dry. Divine spite towards your faith leaves you unable to receive most miracles."), \
	TRAIT_VAELTIAN_GRIT = TAT_TRAIT_ENTRY("Praecursory Willpower", 2, "While you still stand, there is yet hope. The stronger your willpower, the better you can struggle through crippling wounds."), \
	TRAIT_BLACKBLOOD = TAT_TRAIT_ENTRY("Blackblooded", 2, "Your blood, tainted with tinctures and rites, endures infection and holds a regenerative factor. Most healing miracles do not affect you, and you are sensitive to sunlight."), \
	TRAIT_PALLID = TAT_TRAIT_ENTRY("Pallid", 2, "Your eyes pierce the darkness and your lungs need no air. The open sky fills you with unease."), \
	TRAIT_CHOSEN = TAT_TRAIT_ENTRY("Auxentius's Chosen", 2, "Auxentius chose you to represent his glory."), \
	TRAIT_NECRAS_VOW = TAT_TRAIT_ENTRY("Morwenna's Vow", 1, "You've pledged yourself to Morwenna. If you fall, you are Hers."), \
	TRAIT_UNDIVIDED = TAT_TRAIT_ENTRY("The Tribunal Undivided", 1, "You have seen past petty squabbles, and am a true follower of the Tribunal. You feel most comfortable around churchmen."), \
	TRAIT_HERESIARCH = TAT_TRAIT_ENTRY("Forbidden Knowledge", 1, "You've been touched by the truth of the Unveiled. Life as we understand cannot persist under the Concordat's Seats or the Tribunal's Word."), \
	TRAIT_EXCOMMUNICATED = TAT_TRAIT_ENTRY("Excommunicated", -1, "You have been excommunicated from the Church."), \
	TRAIT_BIGGUY = TAT_TRAIT_ENTRY("Big Guy", 2, "Your immense frame and size allows you to smash through wooden doors, and throw people more easily."), \
	TRAIT_DEATHBARGAIN = TAT_TRAIT_ENTRY("Death Bargain", -1, "A horrible deal has been prepared in your name. May you never see it fulfilled..."), \
	TRAIT_UNSATISFIED = TAT_TRAIT_ENTRY("Unsatisfactory Act", -1, "Your encounters leave partners unsatisfied."), \
	TRAIT_COMICSANS = TAT_TRAIT_ENTRY("Annoying Face", -1, "You are cursed with an odd, annoying voice."), \
	TRAIT_SIMPLESPEECH = TAT_TRAIT_ENTRY("Simple Speech", -1, "You can only say the 1000 most common words; other words get modified."), \
	TRAIT_NOHEAL = TAT_TRAIT_ENTRY("Laden Soul", -2, "You cannot be healed by supernatural means. Healing magic has no effect."), \
	TRAIT_NOREGEN = TAT_TRAIT_ENTRY("Laden Body", -2, "You cannot be healed by natural means. Rest and potions have no effect."), \
	TRAIT_HALFHEAL = TAT_TRAIT_ENTRY("Laden Lux", -1, "You have some spiritual oddity to your Lux. Healing magic effectiveness is halved."), \
	TRAIT_ARMOR_BREAK = TAT_TRAIT_ENTRY("Loose Straps", -1, "Your armor's straps are delicate, and may break easily. It's liable to be flung off if it takes too much damage."), \
	TRAIT_CURSE_SCAR = TAT_TRAIT_ENTRY("Curse Scar", -1, "You've been cursed by a foul wench. Those strange fog wards in the bog... what if?"), \
	TRAIT_SUNLIGHT_SENSITIVE = TAT_TRAIT_ENTRY("Sunlight Sensitivity", -1, "Sunlight hurts your eyes! Put on those shades."), \
	TRAIT_EASYDECAPITATION = TAT_TRAIT_ENTRY("Easy Decapitation", -2, "Your neck is vulnerable and can be severed with greater ease."), \
	TRAIT_EASYLIMBDISABLE = TAT_TRAIT_ENTRY("Easy Limb Disable", -1, "Your limbs can be disabled in combat with greater ease."), \
	TRAIT_NOMOOD = TAT_TRAIT_ENTRY("Moodless", 2, "You feel no sorrow, no joy, and no stress."), \
	TRAIT_DEATHLESS = TAT_TRAIT_ENTRY("Deathless", 3, "Even without your lifeblood, you will not be taken by Morwenna so easily."), \
	TRAIT_SECONDLIFE = TAT_TRAIT_ENTRY("Second Life", 2, "You may be granted another chance upon death, but who knows where you'll end up..."), \
	TRAIT_NOPVE = TAT_TRAIT_ENTRY("Natural Accord", 3, "You are a true force of nature. No critter or creature would dare harm you, and you can exert enough influence to deflect the ire of simple-minded mortals as well."), \
	TRAIT_ANTIMAGIC = TAT_TRAIT_ENTRY("Anti-Magic", 3, "You are immune to most forms of magic."), \
	TRAIT_NOHUNGER = TAT_TRAIT_ENTRY("Foodless", 3, "You do not hunger, or thirst."), \
	TRAIT_NOBREATH = TAT_TRAIT_ENTRY("Breathless", 2, "You do not breathe."), \
	TRAIT_INFINITE_ENERGY = TAT_TRAIT_ENTRY("Boundless Energy", 3, "You don't need rest; you won't ever feel fatigue. Infinite fatigue (blue bar) but not infinite stamina."), \
	TRAIT_APRICITY = TAT_TRAIT_ENTRY("Apricity", 1, "The sun's light blesses and rejuvenates you, allowing you to regain your stamina quicker during the day."), \
	TRAIT_FORGEBLESSED = TAT_TRAIT_ENTRY("Forge Blessed", 1, "Countless long nights spent forging metal have honed your endurance, allowing you to work an anvil far longer than most without tiring."), \
	TRAIT_ABYSSOR_SWIM = TAT_TRAIT_ENTRY("Blessing of Wulfric", 1, "You get far less tired when swimming than your peers. You also find mirth in rain and in the midst of storms."), \
	TRAIT_JUSTICARSIGHT = TAT_TRAIT_ENTRY("Blessing of Auxentius", 1, "You are able to remember someone's crimes by looking at them, and how much their bounty is."), \
	TRAIT_EXTEROCEPTION = TAT_TRAIT_ENTRY("Exteroception", 1, "You can see others' hunger and thirst. Pairs well with Empath."), \
	TRAIT_XYLIX = TAT_TRAIT_ENTRY("Thieves' Cant", 1, "You know how to speak in code that only fellow tricksters can understand."), \
	TRAIT_XYLIX_DEVOTEE = TAT_TRAIT_ENTRY("Viatoran Fateweaver", 2, "Viator smiles upon you. When there's a juncture in fate, you will be pulled toward the better outcome."), \
	TRAIT_CRACKHEAD = TAT_TRAIT_ENTRY("Blessing of Hausvette", 1, "You can use drugs as much as you want! You will never overdose."), \
	TRAIT_SOUL_EXAMINE = TAT_TRAIT_ENTRY("Blessing of Morwenna", 1, "You know when someone's soul has departed. You can check bodies to see if they have departed."), \
	TRAIT_MIRROR_MAGIC = TAT_TRAIT_ENTRY("Mirror Magic", 2, "Mirror, mirror on the wall, who's the fairest of them all?"), \
	TRAIT_HEARTFELT = TAT_TRAIT_ENTRY("Heartfelt", 1, "You serve the interests of the Lord of Heartfelt."), \
	TRAIT_WITCH = TAT_TRAIT_ENTRY("Witch", 2, "They fear me, but I am useful to them."), \
	TRAIT_NOC_LIGHT_BLESSING = TAT_TRAIT_ENTRY("Miluse's Light", 2, "You have access to Miluse's moonlight-weapon conjuring."), \
	TRAIT_EORAN_CALM = TAT_TRAIT_ENTRY("Miluse's Calm", 1, "Miluse has touched you, granting you some calm. She protects you from the peaks of your stress."), \
	TRAIT_EORAN_SERENE = TAT_TRAIT_ENTRY("Miluse's Serenity", 2, "Miluse has blessed you with all-encompassing serenity. You feel no more stress."), \
	TRAIT_PESTRAS_BLESSING = TAT_TRAIT_ENTRY("Handwerra's Blessing", 2, "The sacred black rot of Handwerra burns within you. Should intelligent foes try to harm you, they will feel her greatest plague."), \
	TRAIT_SILVER_BLESSED = TAT_TRAIT_ENTRY("Silverblessed", 1, "You have been baptized in fire. Blessed silverdust flows through your blood, protecting you from both vampyrism and lycanthropy."), \
	TRAIT_BLOODLOSS_IMMUNE = TAT_TRAIT_ENTRY("Bloodloss Immune", 1, "While you may bleed, you will feel nothing from it."), \
	TRAIT_LEGENDARY_ALCHEMIST = TAT_TRAIT_ENTRY("Legendary Alchemist", 1, "You are an expert in the art of finding herbs in the wild."), \
	TRAIT_MASTER_CARPENTER = TAT_TRAIT_ENTRY("Master Carpenter", 2, "You've been trained to make the most of wood."), \
	TRAIT_MASTER_MASON = TAT_TRAIT_ENTRY("Master Masonry", 2, "You've been trained to make the most of stone."), \
	TRAIT_MANORKEEPER = TAT_TRAIT_ENTRY("Manorkeeper", 1, "You are a keeper of a manor, with all the rights and responsibilities that entails."), \
	TRAIT_EDIT_DESCRIPTORS = TAT_TRAIT_ENTRY("Edit Descriptors", 1, "You can change your appearance at a magic mirror in a thorough manner."), \
...
#define TAT_TRAIT_DIRECTION_POINT_RULES list( \
	TAT_TRAIT_CONTRACTOR_ENTITY = 2 \
)
...
#define TAT_TRAIT_SKILL_POINT_RULES list( \
	TAT_TRAIT_WARRIOR_EXPERT = list( \
		TAT_SKILL_DOMAIN_COMBAT = TAT_TRAIT_WARRIOR_EXPERT_COMBAT_POINTS \
	), \
...
#define TAT_TRAIT_SKILL_BONUS_RULES list( \
	...
	TAT_TRAIT_SKILLED_COOK = list(/datum/skill/labor/farming = TAT_SKILL_DISCOUNT_BOOST, /datum/skill/craft/cooking = TAT_SKILL_DISCOUNT_BOOST, /datum/skill/labor/fishing = TAT_SKILL_DISCOUNT_BOOST), \
...
GLOBAL_LIST_INIT(tat_trait_direction_point_rules, TAT_TRAIT_DIRECTION_POINT_RULES)
