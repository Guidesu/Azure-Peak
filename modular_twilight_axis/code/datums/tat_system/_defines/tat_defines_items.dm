...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/clothing/neck/roguetown/psicross/morwenna = TAT_ITEM_ENTRY("Matthios Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	...
	/obj/item/clothing/neck/roguetown/psicross/auxentius = TAT_ITEM_ENTRY("Ravox Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
