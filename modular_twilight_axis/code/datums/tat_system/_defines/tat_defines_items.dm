...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/clothing/neck/roguetown/gorget/forlorncollar = TAT_DONATION_ITEM_ENTRY("Forlorn Gorget", 1.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "neck", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/neck/roguetown/psicross/ignatius = TAT_ITEM_ENTRY("Dendor Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	...
	/obj/item/clothing/cloak/tabard/devotee/astrata = TAT_ITEM_ENTRY("Astratan Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	...
	/obj/item/clothing/cloak/tabard/devotee/dendor = TAT_ITEM_ENTRY("Dendor Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
