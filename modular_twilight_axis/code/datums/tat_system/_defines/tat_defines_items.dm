...
#ifndef TAT_DONATION_ITEM_ENTRY
...
#define TAT_AVAILABLE_ITEMS_LIST \
	...
	/obj/item/gun/ballistic/revolver/grenadelauncher/crossbow/slurbow = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Slurbow", 2, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_STEEL, "ranged", "tat_ranged_supplier"), \
	/obj/item/quiver/arrows = TAT_ITEM_ENTRY("Broadhead Arrows", 1, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "munition"), \
	/obj/item/quiver/bodkin = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Bodkin arrows", 3, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_STEEL, "munition", "tat_ranged_supplier"), \
	...
	/obj/item/rogueweapon/scythe/silver = TAT_ITEM_ENTRY("Silver Scythe", 2, "weapon", "weapon_supply", TAT_SUPPLY_SILVER, "polearm"), \
	...
	/obj/item/rogueweapon/sword/short/psy = TAT_ITEM_ENTRY("Vaeltic Shortsword", 3.5, "weapon", "weapon_supply", TAT_SUPPLY_SILVER, "sword"), \
	...
	/obj/item/clothing/gloves/roguetown/cloth = TAT_ITEM_ENTRY("Padded Mittens", 1, "clothing", "armor_family", TAT_ARMOR_CLOTH, "gloves"), \
	...
	/obj/item/clothing/head/roguetown/helmet/bascinet/etruscan/iron = TAT_ITEM_ENTRY("Iron Klappvisier Bascinet", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/bascinet/pigface/iron = TAT_ITEM_ENTRY("Iron Pigface Bascinet", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/bascinet/pigface/hounskull/iron = TAT_ITEM_ENTRY("Iron Hounskull Bascinet", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/bascinet/pigface/roundface/iron = TAT_ITEM_ENTRY("Iron Roundface Bascinet", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/beakhelm/iron = TAT_ITEM_ENTRY("Beaked Iron Helmet", 1.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/guard/iron = TAT_ITEM_ENTRY("Savoyard", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/heavy/guard/bogman/iron = TAT_ITEM_ENTRY("Bogman's Helmet", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/heavy/knight/armet/iron = TAT_ITEM_ENTRY("Iron Armet", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/heavy/knight/skettle/iron = TAT_ITEM_ENTRY("Slitted Iron Kettle Helm", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	/obj/item/clothing/head/roguetown/helmet/heavy/sheriff/iron = TAT_ITEM_ENTRY("Barred Iron Helmet", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/psysallet = TAT_DONATION_ITEM_ENTRY("Vaeltic Sallet", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/head/roguetown/helmet/kettle/jingasa = TAT_DONATION_ITEM_ENTRY("Jingasa", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "head", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/head/roguetown/helmet/sallet/beastskull = TAT_DONATION_ITEM_ENTRY("Beastskull", 3.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "head", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/head/roguetown/helmet/sallet/raneshen = TAT_DONATION_ITEM_ENTRY("Kulah Khud", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "head", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/head/roguetown/helmet/sallet/shishak = TAT_DONATION_ITEM_ENTRY("Steel Shishak", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/head/roguetown/helmet/winged/iron = TAT_ITEM_ENTRY("Iron Winged Helmet", 1.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "head"), \
	/obj/item/clothing/mask/rogue/facemask = TAT_ITEM_ENTRY("Iron Mask", 1, "clothing", "weapon_supply", TAT_SUPPLY_IRON, "mask"), \
	/obj/item/clothing/mask/rogue/facemask/praecursormask = TAT_ITEM_ENTRY("Vaeltic Mask", 1.5, "clothing", "weapon_supply", TAT_SUPPLY_STEEL, "mask"), \
	...
	/obj/item/clothing/mask/rogue/facemask/steel/kazengun/full = TAT_DONATION_ITEM_ENTRY("Soldier's Mask", 2, "clothing", "weapon_supply", TAT_SUPPLY_STEEL, "mask", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/mask/rogue/facemask/steel/steppesman = TAT_DONATION_ITEM_ENTRY("Steppesman Mask", 2, "clothing", "weapon_supply", TAT_SUPPLY_STEEL, "mask", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/neck/roguetown/chaincoif/iron/full = TAT_ITEM_ENTRY("Full Iron Chaincoif", 2, "clothing", "armor_family", TAT_ARMOR_MAIL, "neck"), \
	...
	/obj/item/clothing/neck/roguetown/gorget/forlorncollar = TAT_ITEM_ENTRY("Forlorn Gorget", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "neck"), \
	...
	/obj/item/clothing/shoes/roguetown/boots/otavan = TAT_DONATION_ITEM_ENTRY("Otavan Leather Boots", 1.5, "clothing", "armor_family", TAT_ARMOR_LEATHER, "shoes", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/shoes/roguetown/boots/praecursorboots = TAT_ITEM_ENTRY("Vaeltic Boots", 1.5, "clothing", "armor_family", TAT_ARMOR_LEATHER, "shoes"), \
	...
	/obj/item/clothing/suit/roguetown/armor/chainmail/hauberk/ornate = TAT_ITEM_ENTRY("Vaeltic Hauberk", 3.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor"), \
	...
	/obj/item/clothing/suit/roguetown/armor/leather/heavy/coat/raneshen = TAT_DONATION_ITEM_ENTRY("Megarmach Scale Coat", 2, "clothing", "armor_family", TAT_ARMOR_LEATHER, "armor", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/fluted = TAT_DONATION_ITEM_ENTRY("Fluted Half-Plate", 3.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor", TAT_DONATION_TIER_ONE), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/fluted = TAT_DONATION_ITEM_ENTRY("Fluted Plate", 3.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor", TAT_DONATION_TIER_ONE), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/full/samsibsa = TAT_DONATION_ITEM_ENTRY("Samsibsa Scaleplate", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/under/roguetown/tights/hose = TAT_ITEM_ENTRY("Cloth Hosen", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	/obj/item/clothing/under/roguetown/tights/clothlegs = TAT_ITEM_ENTRY("Padded Chausses", 1.5, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants"), \
	...
	/obj/item/clothing/under/roguetown/trou/artipants = TAT_DONATION_ITEM_ENTRY("Tinker Trousers", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "pants", TAT_DONATION_TIER_ONE), \
	...
	/obj/item/storage/belt/rogue/leather/iron = TAT_ITEM_ENTRY("Iron Belt", 1, "clothing", "armor_family", TAT_ARMOR_MAIL, "belt"), \
	...
	/obj/item/storage/belt/rogue/leather/iron/tasset = TAT_ITEM_ENTRY("Tasseted Iron Belt", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "belt"), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/praecursorhelm = TAT_DONATION_ITEM_ENTRY("Vaeltic Helm", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head", TAT_DONATION_TIER_ONE), \
	/obj/item/clothing/head/roguetown/helmet/heavy/psybucket = TAT_DONATION_ITEM_ENTRY("Vaeltic Bucket", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head", TAT_DONATION_TIER_ONE), \
	...
	/obj/item/clothing/under/roguetown/heavy_leather_pants/otavan/generic = TAT_DONATION_ITEM_ENTRY("Fencing Breeches", 1.5, "clothing", "armor_family", TAT_ARMOR_LEATHER, "pants", TAT_DONATION_TIER_ONE), \
	...
	/obj/item/clothing/gloves/roguetown/chain/psydon = TAT_ITEM_ENTRY("Vaeltic Gloves ", 1.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "gloves"), \
	...
	/obj/item/clothing/suit/roguetown/armor/brigandine/gronn = TAT_DONATION_ITEM_ENTRY("Gronn Byrine Hauberk", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "armor", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/head/roguetown/helmet/bascinet/atgervi/gronn/ownel = TAT_DONATION_ITEM_ENTRY("Gronn Ownel Helm", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "head", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/suit/roguetown/armor/gambeson/heavy/otavan = TAT_DONATION_ITEM_ENTRY("fencing gambeson", 3, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/suit/roguetown/armor/gambeson/heavy/grenzelhoft = TAT_DONATION_ITEM_ENTRY("Grenzelhoftian Hip-Shirt", 3, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/head/roguetown/helmet/heavy/praecursorbarbute = TAT_DONATION_ITEM_ENTRY("Vaeltic Barbute", 2.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head", TAT_DONATION_TIER_ONE), \
	...
	/obj/item/natural/whetstone = TAT_ITEM_ENTRY("Whetstone", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "smith"), \
	...
	/obj/item/handmirror = TAT_ITEM_ENTRY("Hand Mirror", 1, "misc", "weapon_supply", TAT_SUPPLY_IRON, "lyfe"), \
	/obj/item/rogueweapon/shovel = TAT_ITEM_ENTRY("Shovel", 1, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	/obj/item/rogueweapon/shovel/small = TAT_ITEM_ENTRY("Shovel", 0.5, "weapon", "weapon_supply", TAT_SUPPLY_IRON, "misc"), \
	...
	/obj/item/quiver/Warrows = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Water Arrows", 1, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_IRON, "munition", "tat_ranged_supplier"), \
	...
	/obj/item/rogueweapon/shield/tower/metal/psy = TAT_ITEM_ENTRY("Vaeltic Shield", 5, "weapon", "weapon_supply", TAT_SUPPLY_ARTIFACTS, "artifact"), \
	...
	/obj/item/clothing/gloves/roguetown/chain = TAT_ITEM_ENTRY("Chain Gauntlets", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "gloves"), \
	...
	/obj/item/clothing/gloves/roguetown/chain/iron = TAT_ITEM_ENTRY("Iron Chain Gauntlets", 1.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "gloves"), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/cuirass/fluted/ornate = TAT_ITEM_ENTRY("Vaeltic Cuirass", 2.5, "clothing", "armor_family", TAT_ARMOR_MAIL, "armor"), \
	...
	/obj/item/clothing/head/roguetown/helmet/sallet/iron/banded = TAT_ITEM_ENTRY("Branded Helm", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "head"), \
	...
	/obj/item/clothing/neck/roguetown/gorget/steel/kazengun = TAT_DONATION_ITEM_ENTRY("Kazengunite Gorget", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "neck", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/suit/roguetown/armor/leather/heavy/coat/gravecoat = TAT_DONATION_ITEM_ENTRY("Gravetender's Coat", 2, "clothing", "weapon_supply", TAT_SUPPLY_SILVER, "armor", TAT_DONATION_TIER_ONE),\
	/obj/item/clothing/head/roguetown/inqhat/gravehat = TAT_DONATION_ITEM_ENTRY("Gravetender's Hat", 1.5, "clothing", "weapon_supply", TAT_SUPPLY_SILVER, "head", TAT_DONATION_TIER_ONE),\
	/obj/item/clothing/neck/roguetown/psicross/miluse = TAT_ITEM_ENTRY("Noc Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/auxentia = TAT_ITEM_ENTRY("Auxentian Bracelet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/miluse/bronze = TAT_ITEM_ENTRY("Bronze Noc Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_BRONZE, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/miluse/aalloy = TAT_ITEM_ENTRY("Decreipt Noc Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	...
	/obj/item/clothing/neck/roguetown/psicross/aurelian/aalloy = TAT_ITEM_ENTRY("Zizo Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/aurelian/iron = TAT_ITEM_ENTRY("Zizo Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/morwenna/matthios = TAT_ITEM_ENTRY("Matthios Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	...
	/obj/item/clothing/neck/roguetown/psicross/miluse = TAT_ITEM_ENTRY("Eora Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/viator = TAT_ITEM_ENTRY("Xylix Amulet", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	...
	/obj/item/clothing/head/roguetown/grenzelhofthat = TAT_DONATION_ITEM_ENTRY("Plume Hat", 1, "clothing", "armor_family", TAT_ARMOR_LEATHER, "head", TAT_DONATION_TIER_ONE), \
	/obj/item/gun/ballistic/revolver/grenadelauncher/crossbow/heavy = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Siegebow", 4, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_STEEL, "ranged", "tat_ranged_supplier"), \
	/obj/item/quiver/bolt/heavy/standard = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Heavy Bolts", 2, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_STEEL, "munition", "tat_ranged_supplier"), \
	/obj/item/quiver/bolt/heavy/bronze = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Heavy Bronze Bolts", 2, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_BRONZE, "munition", "tat_ranged_supplier"), \
	/obj/item/quiver/bolt/heavy/blunt = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Heavy Blunt Bolts", 2, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_IRON, "munition", "tat_ranged_supplier"), \
	/obj/item/quiver/bolt/heavy/silver = TAT_ITEM_ENTRY_REQUIRES_TRAIT("Heavy Silver Bolts", 2, "weapon", TAT_UNLOCK_TYPE_WEAPON_SUPPLY, TAT_SUPPLY_SILVER, "munition", "tat_ranged_supplier"), \
	...
	/obj/item/rogue/instrument/hurdygurdy = TAT_ITEM_ENTRY("Hurdy Gurdy", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "music"), \
	...
	/obj/item/storage/backpack/rogue/satchel/short = TAT_ITEM_ENTRY("Short Satchel", 1.5, "misc", "armor_family", TAT_ARMOR_CLOTH, "belt"), \
	...
	/obj/item/clothing/suit/roguetown/shirt/robe/ignatius = TAT_ITEM_ENTRY("Ignatian Robe", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "under cloak"), \
	...
	/obj/item/clothing/suit/roguetown/shirt/robe/auxentius = TAT_ITEM_ENTRY("Auxentian Robe", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "under cloak"), \
	/obj/item/clothing/suit/roguetown/shirt/tunic = TAT_ITEM_ENTRY("Tunic", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "suit"), \
	/obj/item/clothing/suit/roguetown/shirt/undershirt/artificer = TAT_DONATION_ITEM_ENTRY("Tinker Jacket", 0, "clothing", "weapon_supply", TAT_SUPPLY_BRONZE, "suit", TAT_DONATION_TIER_ONE), \
	/obj/item/clothing/suit/roguetown/armor/leather/jacket/artijacket = TAT_DONATION_ITEM_ENTRY("Tinker Suit", 0, "clothing", "weapon_supply", TAT_SUPPLY_BRONZE, "armor", TAT_DONATION_TIER_ONE), \
	...
	/obj/item/clothing/suit/roguetown/armor/plate/iron/gronn = TAT_DONATION_ITEM_ENTRY("Gronn Norsii Iron Plate", 3.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "armor", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/gloves/roguetown/plate/iron/gronn = TAT_DONATION_ITEM_ENTRY("Gronn Norsii Iron Gauntlets", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "gloves", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/under/roguetown/platelegs/iron/gronn = TAT_DONATION_ITEM_ENTRY("Gronn Norsii Plate Legs", 1.5, "clothing", "armor_family", TAT_ARMOR_PLATE, "pants", TAT_DONATION_TIER_TWO), \
	/obj/item/clothing/shoes/roguetown/boots/armor/iron/gronn = TAT_DONATION_ITEM_ENTRY("Gronn Norsii Iron Plated Boots", 1, "clothing", "armor_family", TAT_ARMOR_PLATE, "shoes", TAT_DONATION_TIER_TWO), \
	...
	/obj/item/clothing/cloak/tabard/devotee/pestra = TAT_ITEM_ENTRY("Pestran Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/tabard/devotee/malum = TAT_ITEM_ENTRY("Malumite Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/tabard/devotee/necra = TAT_ITEM_ENTRY("Necran Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	...
	/obj/item/clothing/cloak/tabard/devotee/auxentius = TAT_ITEM_ENTRY("Auxentian Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/tabard/devotee/noc = TAT_ITEM_ENTRY("Noc Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/tabard/devotee/abyssor = TAT_ITEM_ENTRY("Abyssor Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/tabard/devotee/ignatius = TAT_ITEM_ENTRY("Ignatius Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	/obj/item/clothing/cloak/tabard/devotee/eora = TAT_ITEM_ENTRY("Eoran Tabard", 0, "clothing", "armor_family", TAT_ARMOR_CLOTH, "cloak"), \
	...
	/obj/item/clothing/neck/roguetown/psicross/aurelian/gronn = TAT_ITEM_ENTRY("Plotting Talisman", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/hausvette/gronn = TAT_ITEM_ENTRY("Relishing Talisman", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/morwenna/gronn = TAT_ITEM_ENTRY("Starving Talisman", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/volkovoi/gronn = TAT_ITEM_ENTRY("Grinning Talisman", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/ignatius/gronn = TAT_ITEM_ENTRY("Volfskinned Talisman", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/wulfric/gronn = TAT_ITEM_ENTRY("Hadal Talisman", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
	/obj/item/clothing/neck/roguetown/psicross/aurelian/gronn/special = TAT_ITEM_ENTRY("Familial Talisman", 0, "misc", "weapon_supply", TAT_SUPPLY_IRON, "cross"),\
