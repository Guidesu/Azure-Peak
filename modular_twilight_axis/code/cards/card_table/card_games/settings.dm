/datum/card_table_session/proc/set_game(new_game, mob/user)
	...
	defender_index = 2
	dealer_rounds = 0
	message = "[card_table_display_name(user)]  : [game_label()]."
	return TRUE
...
/datum/card_table_session/proc/set_fool_variant(new_variant, mob/user)
	...
	message = "[card_table_display_name(user)]  : [fool_variant_label()]."
	return TRUE
...
/datum/card_table_session/proc/set_poker_variant(new_variant, mob/user)
	...
	message = "[card_table_display_name(user)]  : [poker_variant_label()]."
	return TRUE
...
/datum/card_table_session/proc/set_blackjack_variant(new_variant, mob/user)
	...
	message = "[card_table_display_name(user)]  : [blackjack_variant_label()]."
	return TRUE
...
/datum/card_table_session/proc/set_solitaire_variant(new_variant, mob/user)
	...
	message = "[card_table_display_name(user)]  : [solitaire_variant_label()]."
	return TRUE
...
/datum/card_table_session/proc/set_dealer_rotation(rotates, mob/user)
	...
	if(!dealer_rotates && players.len)
		...
		dealer_index = 1
	message = "[card_table_display_name(user)]  : [dealer_rotation_label()]."
	return TRUE
...
/datum/card_table_session/proc/release_user(mob/user, silent = FALSE)
	...
	if(changed)
		if(!silent)
			message = "[card_table_display_name(user)]  ."
