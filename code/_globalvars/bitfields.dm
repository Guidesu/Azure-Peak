...
// It appears we have both the old icon smoothing bitfield and the new turf smoothing bitfield, so I am defining it here for now and leaving it be
...
DEFINE_BITFIELD(weapon_flags, list(
...
DEFINE_BITFIELD(mob_fovangle, list(
