...
'sound/combat/fracture/headcrush (4).ogg')
			...
			if("bladewooshmed")
				soundin = pick('sound/combat/wooshes/bladed/wooshmed (1).ogg','sound/combat/wooshes/bladed/wooshmed (2).ogg','sound/combat/wooshes/bladed/wooshmed (3).ogg')
			if("bladewooshlarge")
				soundin = pick('sound/combat/wooshes/bladed/wooshlarge (1).ogg','sound/combat/wooshes/bladed/wooshlarge (2).ogg','sound/combat/wooshes/bladed/wooshlarge (3).ogg')
			if("bladewooshhuge")
				soundin = pick('sound/combat/wooshes/bladed/wooshhuge (1).ogg','sound/combat/wooshes/bladed/wooshhuge (2).ogg','sound/combat/wooshes/bladed/wooshhuge (3).ogg')
			if("bluntwooshmed")
			...
			if("bluntwooshhuge")
				soundin = pick('sound/combat/wooshes/blunt/wooshhuge (1).ogg','sound/combat/wooshes/blunt/wooshhuge (2).ogg','sound/combat/wooshes/blunt/wooshhuge (3).ogg')
			if("whipwoosh")
				soundin = pick('sound/combat/wooshes/whip_crack1.ogg','sound/combat/wooshes/whip_crack2.ogg','sound/combat/wooshes/whip_crack3.ogg')
			if("punchwoosh")
