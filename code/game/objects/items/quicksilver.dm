...
/obj/item/quicksilver/proc/anoint(mob/living/carbon/human/M, mob/living/carbon/human/user) //Time to deconvert some antagonists
	...
	if(Were && !Wereless) //The roundstart elder/alpha werewolf, it cannot be saved
		to_chat(M, span_userdanger("This wretched silver weighs heavy on my brow. Ignatius's blessing shall not be quit of me so easily."))
...
/obj/item/paper/inquisition_poultice_info
	...
	info = {"
		<font face=\"Segoe Script\" color=#00000>Greetings to ye, distant missionaries at the outpost<br><br>This missive serves to inform of a breakthrough of alchemy.
		...
		employs that need direction in this rite.<br><br><b>PRAECURSOR ENDURES,</b><br><i>Holy Fellowship of Research, the Grand Cathedral, the Sovereignty of Otava.</i></font>
		"}
