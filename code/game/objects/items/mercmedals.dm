/obj/item/merctoken
	...
	desc = "A small, palm-fitting bound scroll - a writ of commendation for a mercenary at the outpost."
	...
	if(istype(P, /obj/item/natural/thorn) || istype(P, /obj/item/natural/feather))
		...
		if(user.can_read(src))
			...
			if(user.mind.assigned_role != "Mercenary") // NOTE: anyone can hire a mercenary
				...
				desc = "A small, palm-fitting bound scroll that can be sent by mail to the Guild. Most of the fine print is unintelligible, save for one bold SIGNEE: [signee], [signeejob] of the outpost."
				signed = 1
				return
		else
			if(signed == 0)
...
/obj/item/clothing/neck/roguetown/luckcharm/mercmedal/grenzelhoft
	...
	desc = "A parody of the brass medal issued to Grenzelhoftian soldiers of great honor and renown. Frequently adopted as medals by other, younger guilds among the mercenaries of VAELTIS, with slight adjustment."
...
/obj/item/clothing/neck/roguetown/luckcharm/mercmedal/desertrider
	...
	desc = "A luxuriant golden chain worn about the shoulders or neck, a sign of high honor in distant Raneshen. Some claim these are a testament to the origins of the Desert Riders in distant slave-fighting pits, but \
...
/obj/item/clothing/neck/roguetown/luckcharm/mercmedal/atgervi
	...
	desc = "A humble token of tightly-wound canvas, fur, and wood. A piece of home, clutched tight against the chest. Feel its heart beat in tyme with your own. Even here, at the distant outpost, \
...
/obj/item/clothing/neck/roguetown/luckcharm/mercmedal/routier
	...
	home, blessed Otava, and their Weeping God, PRAECURSOR."
