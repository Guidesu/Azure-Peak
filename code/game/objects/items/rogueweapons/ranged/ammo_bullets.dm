...
/obj/projectile/bullet/reusable/bullet
	...
	armor_penetration = PEN_NONE
	speed = 0.1
	npc_simple_damage_mult = 2 // I know this isn't used at the outpost but trust me some downstream guys are going to thank me for this because everything that uses it shoots so fucking slow that even volves are hard to kill.
