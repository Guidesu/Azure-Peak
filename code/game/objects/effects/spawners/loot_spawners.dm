...
/obj/effect/spawner/lootdrop/general_loot_low
	...
	loot = list(
		...
		/obj/item/weapon_mod/grip_wire = 1,
		/obj/item/weapon_mod/pommel_heavy = 1,
		/obj/item/weapon_mod/pommel_light = 1,
		/obj/item/weapon_mod/boss_iron = 1,
		/obj/item/weapon_mod/rim_metal = 1,
		/obj/item/weapon_mod/blade_coating_rust = 1,
