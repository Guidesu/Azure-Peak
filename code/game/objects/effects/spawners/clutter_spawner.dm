...
/obj/effect/spawner/lootdrop/cheap_jewelry_spawner
	...
	loot = list(
		...
		/obj/item/clothing/neck/roguetown/psicross/auxentius = 6,
		/obj/item/clothing/neck/roguetown/psicross/miluse = 6,
		/obj/item/clothing/neck/roguetown/psicross/wulfric = 6,
		/obj/item/clothing/neck/roguetown/psicross/ignatius = 6,
		/obj/item/clothing/neck/roguetown/psicross/morwenna = 6,
		/obj/item/clothing/neck/roguetown/psicross/handwerra = 6,
		/obj/item/clothing/neck/roguetown/psicross/auxentius = 6,
		/obj/item/clothing/neck/roguetown/psicross/handwerra = 6,
		/obj/item/clothing/neck/roguetown/psicross/miluse = 6,
...
/obj/effect/spawner/lootdrop/valuable_jewelry_spawner
	...
	loot = list(
		...
		/obj/item/clothing/neck/roguetown/psicross/handwerra/secret = 1,
