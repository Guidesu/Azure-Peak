...
/obj/structure/plasticflaps/CanAStarPass(ID, to_dir, pathing_mover)
	if(isliving(pathing_mover))
		var/mob/living/M = pathing_mover
		if(!M.ventcrawler && M.mob_size != MOB_SIZE_TINY)
			return FALSE
	var/atom/movable/M = pathing_mover
	if(M && M.pulling)
