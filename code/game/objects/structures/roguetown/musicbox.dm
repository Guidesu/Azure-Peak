...
/obj/structure/roguemachine/musicbox
	...
	desc = "A marvelous device invented to record sermons. Aleksandar Gemrald Sparks invented this machine to discover prophecies of Praecursor's return but failed. It now brings us strange music from another realm."
