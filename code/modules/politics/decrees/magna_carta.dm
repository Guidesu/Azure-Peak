/datum/decree/magna_carta
	...
	mechanical_text = "Zeroes every Crown levy. Fines remain. The Crown collects only voluntary tribute."
	active = FALSE
	flavor_text = {"%RULER_NAME%, by the grace of Auxentius, %RULER% of Azuria, Count of Kingsfield, Blackholt, and Saltwick, Overlord of Rosawood, Rockhill, and Daftsmarch, Protector of Bleakcoast, Northfort, and Heartfelt, Defender of the Six, to his archbishops, priests, templars, inquisitors, dukes, princes, consorts, hands, stewards, councillors, clerks, marshals, knights, sergeants, men-at-arms, wardens, squires, court magicians, archivists, apothecaries, head physicians, merchants, innkeepers, bathmasters, guildsmen, burghers, residents, peasants, farmers, cooks, tapsters, bathmaids, servants, soilsons, mercenaries, adventurers, pilgrims, and to all his officials and loyal subjects, Greeting.

Know ye, that for the health of our soul, for the common benefit of the Realm, to the honour of the Six, the exaltation of the holy Church, and the better ordering of our kingdom, we have granted unto every subject of Azuria, of whatsoever rank, station, or origin, that they shall bear no tax, no levy, no tariff, no duty, nor any fiscal imposition whatsoever upon their persons, estates, goods, labours, or callings, nor upon the instruments thereof, neither in coin nor in kind.
...
Yeven under the seal of %RULER_NAME%, %RULER% of this yeer, who shall be remembered for it."}
	revoke_text = "Hear ye, hear ye. %RULER_NAME%, by the grace of Auxentius, %RULER% of Azuria, Count of Kingsfield, Blackholt, and Saltwick, Overlord of Rosawood, Rockhill, and Daftsmarch, Protector of Bleakcoast, Northfort, and Heartfelt, Defender of the Six, hath this day set aside the Magna Carta. The Realm's subjects are hereby restored to their accustomed fiscal obligations, and the Crown's revenue is restored in kind. Let the record reflect the reconsideration of %RULER_NAME%."
