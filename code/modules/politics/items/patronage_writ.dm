...
/obj/item/patronage_writ/charter
	...
	desc = "A writ of the Stewardry. Claim it for chartered agency."
	granted_trait = TRAIT_AGENT_MERCHANT
	faction_label = "the Stewardry"
...
/obj/item/patronage_writ/benefactor
	...
	desc = "A sealed letter of the local Church, conferring the rank of Benefactor upon its bearer."
	granted_trait = TRAIT_AGENT_CHURCH
	faction_label = "the Church"
