...
/datum/book_entry/treasury_realm/defense/inner_book_html(mob/user)
	return {"
		...
		<p>Defense commissions pay out in proportion to the threat they spawn. Each threat region carries a <b>reward multiplier</b> (surfaced in the commission UI beside the region name): Greenvalley Basin at x0.75, Whispering Grove at x1.0, Sunken Coast at x1.2, Terrorbog / Mount Cull / Underdark at x1.5. A Bounty in Terrorbog costs the same draft as a Bounty in Azure Basin - but the Terrorbog commission pays the bearer roughly twice as much. The Steward can use this to steer adventurers toward regions the Outpost most needs cleared.</p>
