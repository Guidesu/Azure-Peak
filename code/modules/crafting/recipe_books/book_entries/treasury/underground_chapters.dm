...
/datum/book_entry/treasury_underground/black_market/inner_book_html(mob/user)
	return {"
		<div>
		<p><b>BLACK MARKET:</b> Merchant letting you down? Stolen 100 cutleries from the Keep and have nothing to do with it but sneed? The Black Market is your friend! Just walk all the way across the Outpost's famously safe Grove and Coast to a little island in the northeast, and dump your goods. The Bathmatron and </p>
		...
		<h3>The Ordinance</h3>
		<ul>
			<p>The Church and the Bathhouse have signed an agreement that the Bathhouse will not sell any items that violate the Ordinance, and that in exchange the Church shall not interfere with the Bathhouse's business, and take it under their protection. The Ordinance's details can be read in the
