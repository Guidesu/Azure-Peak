...
/datum/book_entry/cuisine/south_imperial
	...
	blurb = "A grandiose name for the cuisine that developed along the outpost's coast during its heyday, when snow elves still ruled from the mountain valley of Tarichea. It incorporated elements of North Imperial food - namely the hearty staple of breads, tomatoplate and bookbreads - and deliberately excludes pies (excluding crab and fish pies), which are viewed as food suitable for campaigning but not for a noble tongue. Compared to its northern counterpart, it includes practically all seafood dishes, specifically fish pies (and no other pies) and anything with fish as a coastal staple. It includes elements of wood elven cuisine, incorporated as a native and uniquely local aspect, and Tarichean and coastal lords made sure to dine on them conspicuously to show that they are both capable of imitation and innovation - honey, mead, slow roasted fishes, game, rosa tea - all elements of the Rosawoodian diet that the nobles and burghers of this land eat with pride."
