...
/datum/supply_pack/rogue/rosawood/elvish_longsword
	name = "Elvish Longsword"
	cost = 95
	contains = list(/obj/item/rogueweapon/sword/long/elvish)

/datum/supply_pack/rogue/rosawood/elvish_shortsword
	name = "Elvish Shortsword"
	cost = 65
	contains = list(/obj/item/rogueweapon/sword/short/elvish)

/datum/supply_pack/rogue/rosawood/elvish_curveblade
	name = "Elvish Curveblade"
	cost = 120
	contains = list(/obj/item/rogueweapon/greatsword/elvish)

/datum/supply_pack/rogue/rosawood/elvish_glaive
	name = "Elvish Glaive"
	cost = 110
...
/datum/supply_pack/rogue/rosawood/woad_helm_light
...
/datum/supply_pack/rogue/rosawood/woad_plate_light
...
/datum/supply_pack/rogue/rosawood/woad_recurve_bow
	name = "Woad Recurve Bow"
	cost = 65
	contains = list(/obj/item/gun/ballistic/revolver/grenadelauncher/bow/recurve/blackoak)
...
/datum/supply_pack/rogue/rosawood/javelins
	name = "Quiver of Javelins"
	cost = 50
