...
/obj/item/clothing/head/roguetown/helmet/heavy/undivided
	...
	desc = "A silver-plated jousting helm, and symbol of hope worn by a local sect of The Undivided. Those who don it have sworn to lay down their lyves for the greater good, for no cost is too great to preserve Their will."
...
/obj/item/clothing/head/roguetown/helmet/heavy/undivided_ritual/Initialize(mapload)
	..()
