...
/obj/item/clothing/suit/roguetown/shirt/dress/royal
	...
	name = "royal gown"
	desc = "An elaborate ball gown, a favoured fashion of queens and elevated nobility throughout Vaeltis." //Enigma references still exist in code, those are gonna need the chop.
	body_parts_covered = CHEST|GROIN|ARMS|VITALS
...
/obj/item/clothing/suit/roguetown/shirt/dress/captainrobe
	slot_flags = ITEM_SLOT_SHIRT|ITEM_SLOT_ARMOR
	name = "foreign robes"
	desc = "Flower-styled robes. The trading post's factor swears they came up the harbor from the southern Kazeungese region."
