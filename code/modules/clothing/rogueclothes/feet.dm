...
/obj/item/clothing/shoes/roguetown/boots/praecursorboots
	name = "vaeltic leather boots"
...
/obj/item/clothing/shoes/roguetown/boots/praecursorboots/ComponentInitialize()
