...
/obj/item/clothing/head/roguetown/helmet/heavy/banneret/sallet
	name = "banneret's snouted sallet"
...
/obj/item/clothing/head/roguetown/helmet/heavy/banneret/bascinet
	name = "banneret's snouted bascinet"
