...
/obj/item/clothing/suit/roguetown/armor/brigandine/banneret
	...
	desc = "A resplendant coat-of-plates, gilded and veiled in dyeable silk. Only the finest of the outpost's knights has been entrusted with this beautiful article."
	icon_state = "capplate"
