/datum/job/roguetown/watchman //This exists PURELY so the convert verb has something TO convert to
	...
	tutorial = "You are the club in the dark for the outpost, patrolling its streets dae and nite on the lookout for knaves and vagabonds looking to cause trouble. \
				Obey the Sergeant and the Marshal for their own your lyfe, don't forget to ask the men-at-arms for help should you need it either."//Theoretically nobody will ever see this but yknow
