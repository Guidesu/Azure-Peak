...
/datum/outfit/job/roguetown/lord/choose_loadout(mob/living/carbon/human/H)
	...
	if(player.prefs)
		if(!istype(player.prefs.virtue_origin, /datum/virtue/origin/auxentia) && !istype(player.prefs.virtue_origin, /datum/virtue/origin/vergenmark) && !istype(player.prefs.virtue_origin, /datum/virtue/origin/ostrovia))
			var/list/new_origins = list("Auxentia" = /datum/virtue/origin/auxentia,
			"Vergenmark" = /datum/virtue/origin/vergenmark,
			"Ostrovia" = /datum/virtue/origin/ostrovia)
			var/new_origin
			...
			if(choice)
				...
				new_origin = pick(/datum/virtue/origin/auxentia, /datum/virtue/origin/vergenmark, /datum/virtue/origin/ostrovia)
...
/datum/advclass/lord/warrior
	...
	subclass_stashed_items = list(
		"Ducal Caparison (Saiga)" = /obj/item/caparison/blue,
...
/datum/advclass/lord/merchant
	name = "Merchant Lord"
	tutorial = "You were always talented with coins and trade. And your talents have brought you to the position of the Lord of the outpost. You could be a merchant who bought his way into nobility and power, or an exceptionally talented noble who were inclined to be good with coins. Fighting directly is not your forte\
