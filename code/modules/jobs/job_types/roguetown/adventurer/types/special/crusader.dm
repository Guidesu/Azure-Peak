...
/obj/item/clothing/cloak/tabard/stabard/crusader/undivided
	name = "surcoat of the golden order"
	desc = "A regal surcoat, inlined with golden threading. The stitchwork tethers it to the Golden Orders; a catch-all term for the various faith-militances that \
	ward Vaeltis from heathens, cultists, and the ever-looming threat of another calamity. This variant bears the unicruciform sigil of the Undivided and Erranteer \
	orders."
...
/obj/item/clothing/cloak/tabard/stabard/crusader/t/undivided
	name = "surcoat of the silver order"
	desc = "A noble surcoat, inlined with silver threading. The stitchwork tethers it to the Silver Orders; a catch-all term for the various faith-militances that \
	ward Vaeltis from monsters, deadites, and the ever-looming threat of another calamity. This variant bears the unicruciform sigil of the Undivided and Erranteer \
	orders."
...
/obj/item/clothing/cloak/tabard/stabard/crusader/heavy
	...
	the bods of paladin-errants, priests, and pilgrims across Vaeltis's more intemperate climates."
...
/obj/item/clothing/cloak/tabard/stabard/crusader/legacy
	...
	desc = "A regal surcoat, inlined with golden threading. The stitchwork tethers it to the Golden Orders; a catch-all term for the various faith-militances that \
	ward Vaeltis from heathens, cultists, and the ever-looming threat of another calamity. This variant predates them all - stitched by Valorian seamstresses to adorn \
...
/obj/item/clothing/cloak/tabard/stabard/crusader/t/legacy
	...
	desc = "A noble surcoat, inlined with silver threading. The stitchwork tethers it to the Silver Orders; a catch-all term for the various faith-militances that \
	ward Vaeltis from monsters, deadites, and the ever-looming threat of another calamity. This variant predates them all - stitched by Valorian seamstresses to adorn \
