...
/proc/get_blade_chant_text(faction, mob/living/carbon/human/H)
	switch(faction)
		if("blackoak")
			return {"<p><em>I am a blade of Tarichea — this outpost, her ashes reborn!</em></p>
...
<p><b>WAKE UP. WAKE UP.</b></p>"}
	return {"<p><em>I am a blade of the outpost.</em></p>
...
<p><b>WAKE UP. WAKE UP.</b></p>"}
	return {"<p><em>I am a shield of the outpost.</em></p>
...
/proc/get_macebearer_chant_text(faction, mob/living/carbon/human/H)
	switch(faction)
		if("blackoak")
			return {"<p><em>I am a mace of Tarichea — this outpost, her ashes reborn!</em></p>
...
<p><b>WAKE UP. WAKE UP.</b></p>"}
	return {"<p><em>I am a mace of the outpost.</em></p>
