...
/datum/outfit/job/roguetown/adventurer/repentant/pre_equip(mob/living/carbon/human/H)
	...
	shirt = /obj/item/clothing/cloak/tabard/praecursortabard
...
/datum/advclass/foreigner/bronzeclad
	...
	than themselves. You are a skilled combatant from beyond the outpost, who - for one reason or another - is intimately familiar with fighting in ancient equipment."
...
/datum/advclass/foreigner/lesserblackoak
	...
	maximum_possible_slots = 3 //A little stronger than a traditional Nomad or Adventurer. The slot limit is more-so intended to keep them a limited presence at the outpost, and to account for their potentially antagonistic nature.
	subclass_stats = list(
		STATKEY_PER = 2,
		STATKEY_SPD = 2,
...
/datum/outfit/job/roguetown/adventurer/lesserblackoak/pre_equip(mob/living/carbon/human/H)
	..()
	to_chat(H, span_warning("Whether through merit or heritage, you've earned the right of tutelage under the Black Oaks; an irregular militia that fights for the ancestral elven homelands surrounding the outpost. Jaunt through the underbrush and oppress the oppressors with both blade-and-bow."))
	H.set_blindness(0)
	if(H.mind)
...
/obj/item/gun/ballistic/revolver/grenadelauncher/bow/recurve/autumn
	...
	characteristics. Hewn from a highland elk tree branch, it still feels as if it is one \
...
/obj/item/rogueweapon/sword/long/elvish/autumn
	...
	desc = "A curved longsword, hewn from a melody of faeiron and the living bark of a highland \
...
/obj/item/rogueweapon/huntingknife/idagger/elvish/autumn
	...
	desc = "A wave-bladed dagger of faeiron, fitted from the branch of a highland elk \
...
/obj/item/rogueweapon/halberd/bardiche/elvish/autumn
	...
	desc = "A cleaving polearm, hewn from the branch of a highland elk tree and tipped with a wide blade of faeiron. The \
...
/obj/item/clothing/gloves/roguetown/elven_gloves/autumn
	...
	desc = "Barkgloves that've been freshly weened off the trunk of a sturdy highland elk tree, and \
