...
/datum/advclass/wretch/heretic/get_prefs_vice_limits(client/player)
	. = ..()
	if(istype(player?.prefs?.selected_patron, /datum/patron/tribunal/praecursor))
		if(!(/datum/charflaw/silverweakness in .))
			. += /datum/charflaw/silverweakness
...
/datum/outfit/job/roguetown/wretch/heretic/choose_loadout(mob/living/carbon/human/H)
	...
	switch(H.patron?.type)
		...
		if(/datum/patron/oldkin/volkovoi)
			...
			H.equip_to_slot_or_del(new /obj/item/clothing/neck/roguetown/psicross/volkovoi, SLOT_RING, TRUE)
			H.change_stat(STATKEY_STR, 2)
			H.change_stat(STATKEY_WIL, 1)
		if(/datum/patron/concordat/auxentius)
			H.equip_to_slot_or_del(new /obj/item/clothing/neck/roguetown/psicross/auxentius, SLOT_RING, TRUE)
		...
		if(/datum/patron/concordat/wulfric)
			H.change_stat(STATKEY_INT, 2)
			H.change_stat(STATKEY_PER, 2)
			H.equip_to_slot_or_del(new /obj/item/clothing/neck/roguetown/psicross/wulfric, SLOT_RING, TRUE)
		...
		if(/datum/patron/concordat/viator)
			H.change_stat(STATKEY_INT, 2)
			H.change_stat(STATKEY_PER, 2)
			H.equip_to_slot_or_del(new /obj/item/clothing/neck/roguetown/psicross/viator, SLOT_RING, TRUE)
		...
		if(/datum/patron/concordat/handwerra)
			H.change_stat(STATKEY_INT, 2)
			H.change_stat(STATKEY_PER, 2)
			H.equip_to_slot_or_del(new /obj/item/clothing/neck/roguetown/psicross/handwerra, SLOT_RING, TRUE)
		...
		if(/datum/patron/concordat/miluse)
			H.change_stat(STATKEY_INT, 2)
			H.change_stat(STATKEY_PER, 2)
			H.equip_to_slot_or_del(new /obj/item/clothing/neck/roguetown/psicross/miluse, SLOT_RING, TRUE)
		...
		if(/datum/patron/tribunal/custodius)
			H.change_stat(STATKEY_INT, 2)
			H.change_stat(STATKEY_PER, 2)
			H.equip_to_slot_or_del(new /obj/item/clothing/neck/roguetown/psicross/custodius, SLOT_RING, TRUE)
			H.adjust_skillrank(/datum/skill/magic/holy, 1, TRUE)
