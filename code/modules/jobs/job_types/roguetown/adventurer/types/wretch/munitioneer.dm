...
/datum/outfit/job/roguetown/wretch/munitioneer/pre_equip(mob/living/carbon/human/H)
	to_chat(H, span_warning("You are a passable warrior- though weak- but your true strength lies in your ability to bend the outpost's resources to your will."))
	has_loadout = TRUE
