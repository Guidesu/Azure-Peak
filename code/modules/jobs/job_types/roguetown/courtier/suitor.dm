/datum/job/roguetown/suitor
	...
	tutorial = "You are a noble from a foreign house who has travelled to the outpost in order to win favour of the court nobles and secure a political ally for your house. Competition is fierce, and it seems you're not the only one vying for the courts favor..."
