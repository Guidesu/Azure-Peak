/datum/action/cooldown/spell/projectile/spellblade_pilum
	name = "Royal Pilum"
	desc = "A borrowed art - spellblades of the ancient tradition learned to imbue their throw with ice essence, \
	...
	button_icon_state = "spellblade_javelin"
	sound = 'sound/combat/wooshes/bladed/wooshsmall (1).ogg'
	spell_color = GLOW_COLOR_ARCANE
	glow_intensity = GLOW_INTENSITY_LOW

	projectile_type = /obj/projectile/energy/spellblade_pilum
	projectile_type_arc = /obj/projectile/energy/spellblade_pilum/arc
	cast_range = 15

	primary_resource_type = SPELL_COST_STAMINA
	primary_resource_cost = SPELLCOST_MINOR_PROJECTILE

	invocations = list("Pilum!")
...
/datum/action/cooldown/spell/projectile/spellblade_pilum/cast(atom/cast_on)
	...
	if(cached_empowered)
		projectile_type = /obj/projectile/energy/spellblade_pilum/empowered
		projectile_type_arc = /obj/projectile/energy/spellblade_pilum/empowered/arc
	else
		projectile_type = /obj/projectile/energy/spellblade_pilum
		projectile_type_arc = /obj/projectile/energy/spellblade_pilum/arc
...
/datum/action/cooldown/spell/projectile/spellblade_pilum/ready_projectile(obj/projectile/to_fire, atom/target, mob/user, iteration)
	..()
	to_fire.damage = cached_damage

/obj/projectile/energy/spellblade_pilum
	name = "Royal Pilum"
...
/obj/projectile/energy/spellblade_pilum/on_hit(target)
	. = ..()
	if(isliving(target))
...
/obj/projectile/energy/spellblade_pilum/empowered
	name = "Empowered Royal Pilum"
	icon_state = "youreyesonly"
	color = "#4CADEE"
	frost_stacks = 3

/obj/projectile/energy/spellblade_pilum/arc
	name = "Arced Royal Pilum"
	damage = 26
	arcshot = TRUE

/obj/projectile/energy/spellblade_pilum/empowered/arc
	name = "Empowered Arced Royal Pilum"
	damage = 26
	arcshot = TRUE
