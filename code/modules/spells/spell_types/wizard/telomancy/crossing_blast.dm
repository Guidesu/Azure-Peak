/datum/action/cooldown/spell/telegraphed_strike/crossing_blast
	...
	name = "Crossing Blast"
	desc = "Arm a burst of raw chi force, then release it in radiating arms around you, striking and hurling back everyone nearby. Toggle its shape (Shift+G): a cross strikes the cardinal arms, a saltire the diagonals, and a star both at once."
