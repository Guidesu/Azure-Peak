/datum/action/cooldown/spell/second_chance
	name = "Second Chance"
	desc = "Invigorate a target with bendingal resilience for 30 seconds - they shrug off critical wounds, and no longer stagger from pain."
...
/datum/action/cooldown/spell/second_chance/cast(atom/cast_on)
	...
	target.visible_message(span_warning("[target] is wreathed in bendingal light!"), \
