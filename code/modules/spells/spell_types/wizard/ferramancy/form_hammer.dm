/datum/action/cooldown/spell/form_blade/form_hammer
	name = "Form Hammer"
	desc = "Shape raw chi into a massive arcyne maul, the Grôzehamer. Only one conjured form may exist at a time."
...
/obj/item/rogueweapon/mace/maul/grand/ferramancy
	name = "Grôzehamer"
	desc = "A grand maul of condensed chi force, conjured from raw chi by a metal-bender's will."
	color = "#3b5bdb"
	minstr = 0
	unenchantable = TRUE
	anvilrepair = null
