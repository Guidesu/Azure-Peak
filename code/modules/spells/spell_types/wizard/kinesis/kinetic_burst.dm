/datum/action/cooldown/spell/telegraphed_strike/kinetic_burst
	...
	name = "Kinetic Burst"
	desc = "Wind up raw chi force in a 5x5 area around yourself, then detonate it - hurling everyone caught back, hurting them and leaving them Vulnerable for a moment. \
