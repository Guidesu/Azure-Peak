...
/mob/living/carbon/human/proc/get_heat_protection(temperature) //Temperature is the temperature you're being exposed to.
	...
	// Naturally-furred/hided species (see /datum/species/fur_insulation) get an additive insulation
	// bonus on top of whatever clothing coverage provides.
	if(dna?.species?.fur_insulation)
		thermal_protection += dna.species.fur_insulation
