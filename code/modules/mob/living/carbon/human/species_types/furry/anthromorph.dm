...
/datum/species/anthromorph
	...
	base_name = "Beastvolk"
	desc_title = "Wild-Kin"
	desc = "A product of Ignatius's enigmatic meddling in mortals races. The average wild-kin suffers from animalistic urges that vary in severity, \
	...
	creating a diverse race of people who may not even empathise with one another. And whilst Ignatius is considered the main culprit for Wild-kin, there are those created through other means, \
