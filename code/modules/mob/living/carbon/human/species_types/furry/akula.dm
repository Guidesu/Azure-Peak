...
/datum/species/akula
	...
	base_name = "Beastvolk"
	desc_title = "Axian"
	desc = "Axians are a proud, shark-like people that have a heritage founded in maritime trade, \
	tax evasion, and piracy. They have a strong distaste for the nobility and taxation, \
	making them a target of discrimination in the northern lands. They are oftentimes scapegoats for crime. \
	...
	and often uproot themselves quite often in their lifetimes. However, due to the isolation in these lands, many Axians \
