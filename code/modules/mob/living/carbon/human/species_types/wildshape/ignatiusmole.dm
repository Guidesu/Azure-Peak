/mob/living/carbon/human/species/wildshape/ignatiusmole //The baseline and tracker of the wildshapes
	name = "Moss Crawler"
	race = /datum/species/ignatiusmole
	footstep_type = FOOTSTEP_MOB_CLAW
	ambushable = FALSE
	skin_armor = new /obj/item/clothing/suit/roguetown/armor/skin_armor/moss_skin

/mob/living/carbon/human/species/wildshape/ignatiusmole/death(gibbed, nocutscene = FALSE)
	wildshape_untransform(TRUE, gibbed)

//BUCKLING
/mob/living/carbon/human/species/wildshape/ignatiusmole/buckle_mob(mob/living/target, force = TRUE, check_loc = TRUE, lying_buckle = FALSE, hands_needed = 0, target_hands_needed = 0)
	. = ..(target, force, check_loc, lying_buckle, hands_needed, target_hands_needed)

/mob/living/carbon/human/species/wildshape/ignatiusmole/gain_inherent_skills()
	. = ..()
	if(src.mind)
...
// ignatiusmole SPECIES DATUM //
/datum/species/ignatiusmole
	name = "Moss Crawler"
	id = "ignatiusmole"
...
/datum/species/ignatiusmole/send_voice(mob/living/carbon/human/H)
...
/datum/species/ignatiusmole/regenerate_icons(mob/living/carbon/human/H)
...
/datum/species/ignatiusmole/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	. = ..()
	RegisterSignal(C, COMSIG_MOB_SAY, PROC_REF(handle_speech))

/datum/species/ignatiusmole/update_damage_overlays(mob/living/carbon/human/H)
