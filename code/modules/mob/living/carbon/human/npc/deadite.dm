...
/mob/living/carbon/human/species/npc/deadite/Initialize(mapload)
	. = ..()
	//picked from a list because 1: Races that look better w/deaditing here 2: We need deadite infectable races for immersion's sake I.E not sun elves 3: we can bias towards races common to the local outpost
