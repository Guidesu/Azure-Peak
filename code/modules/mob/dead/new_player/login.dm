...
/mob/dead/new_player/proc/do_after_login()
	...
	if(client.is_new_player())
		...
		if(!shown_patreon_level)
			shown_patreon_level = "<font color='#41acc7'><b>Veteran Chad</b></font>"
		...
		to_chat(src, span_notice("New to the server? The <a href='byond://?src=[REF(client)];open_encyclopedia=1'>Encyclopaedia</a> holds recipes, and guides - you can also find it under the OOC tab."))
