...
/obj/structure/fermentation_keg/spicedwine/Initialize(mapload)
	. = ..()
...
/obj/structure/fermentation_keg/spicedwineaged/Initialize(mapload)
	. = ..()
...
/obj/structure/fermentation_keg/spicedwinedelectable/Initialize(mapload)
	. = ..()
