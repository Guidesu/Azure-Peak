/datum/foreign_realm/ostrovia
	...
	hail_lines = list(
		"In the name of the Isles, and by leave of the harbor-council that stamped my charter, Ostrovia greets the Factor. My hold is long-travelled; do not make it stand idle.",
		"Silk from Chorodiaki, sugar and saffira from Mücevkabher, wine from Nshkormh, geometers' work from Vrdaqnan. One confederation, four manifests; the port clerks were patient with me.",
		"Sit with me before we tally. Among the Tidesworn Isles no one trades with a stranger - we drink first, eat second, and only then count coin. Your hospitality will be remembered as long as your prices.",
		"Hear that flute from my afterdeck? My mate is from Mücevkabher, and she will not bargain unless the bargaining keeps time. Viator smiles on her, she says. I find she haggles harder when the song is fast.",
		"You have fur and timber and iron, and the sea put none of these on our islands in quantity. So we sail. The arithmetic is older than either of us.",
		"My cousin sits on his port-council and reminds me of it at every supper. Yet here I am at your dock, and there he is at his table. Tell me which of us has truly seen the world.",
		...
		"The harbor-council of Vrdaqnan sent a marine aboard to keep the peace among my crew. He has, by dancing with two of them and drinking with the third. I will commend him in my report.",
		"There is a dervish in the third hold who has not stopped spinning since we sighted your cape. He says Miluše's tide still turns in the heavens and so must he. Pay him no mind; pay me promptly.",
		"A geometer of the Vrdaqnan houses rides at my prow, reader of palms by the first light of dawn. He charges in questions, not coin - one question for one reading, no exceptions. He sails to teach what he has learned before the dervish houses no longer commission his work. Bring him a true question and he will not refuse you. Bring him a flattery and he will not refuse you either, but you will not like the answer.",
		"Salt cured mackeral and herring for the long caravan trip to land, chests of ice-bound fishes of all varieties. The inland folk have never seen the sea. My partner will bring it to them.",
		...
		"My cargo of enchanted scrolls is sealed beneath three locks and one charm. Buy them or do not, but do not ask to inspect them.",
		...
		"Peace upon the Company. Ostrovia greets the factor, with the respect owed between honest houses.",
		"I bring glass from the Dunes, gold from Veranda, the finest coffee and tea on the trade road. A thirst for iron that no caravan can slake.",
