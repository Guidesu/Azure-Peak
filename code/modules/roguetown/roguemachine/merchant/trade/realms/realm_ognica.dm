/datum/foreign_realm/ognica
	...
	hail_lines = list(
		...
		"The Fjall is two months under ash already. I wish to be home before the third.",
		...
		"An Iskarn shaman rides with us out of the ash-flats. He speaks to none, eats nothing. Do not approach him - what he watches over does not care for southern eyes.",
		...
		"There is a totem under my sailcloth that is not for sale and not for your church to see. If your magistrate calls it idolatry, your magistrate has not seen real fire.",
