/datum/foreign_realm/kamenrad
	...
	ship_types = list(
		...
		list("name" = "Kamenradi Galley", "tonnage" = 250, "weight" = 25),
	...
	hail_lines = list(
		"Greetings, Factor. Hide, grain, fish and fur. Of the finest quality from the terraces of Kamenrad. Bring me silk and gemerald or do not bring me anything at all.",
		...
		"Trade quickly, friend. The terraces do not wait, and neither do the wolves on my home road.",
		...
		"The Threshold Council weighs heavy on the keel and heavier on my purse. Lighten one and the other follows.",
		...
		"Pickled herrings for the sons and daughters of the terraces. Mare's milk and saiga sausage are great, but our warriors do like to have something foreign to chew on on their march."
	)
