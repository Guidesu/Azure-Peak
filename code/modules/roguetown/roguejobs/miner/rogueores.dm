...
/obj/item/ingot/blacksteel
	name = "blacksteel bar"
	desc = "This ingot is both mythical and mysterious; stronger - and more expensive - than any alloy currently known to Vaeltis's masses. It thrumbs with an eerie blue glow, catchable for only a blink's tyme. </br>'Sacrificing the holy elements of silver for raw strength, this strange and powerful ingot's origin carries dark rumors.'"
...
/obj/item/ingot/silverblessed/bullion
	...
	desc = "This bar radiates with blessed purity. It is marked with the sigil of the Holy Vaeltic Inquisition, and appears to've been shipped straight from Otava's treasury."
