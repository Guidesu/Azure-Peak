...
// ============================================================================
// demand_arcane_commission - enchantment scrolls commissioned by non-producing regions.
// Rosawood is the producer - the demand fires elsewhere, paying the outpost
// to broker. Rolls one of three tiers, weighted toward routine basic-tier orders.
// ============================================================================
