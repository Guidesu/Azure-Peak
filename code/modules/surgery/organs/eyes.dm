...
/obj/item/organ/eyes/Remove(mob/living/carbon/M, special = FALSE, drop_if_replaced = TRUE)
	. = ..()
...
/obj/item/organ/eyes/robotic/glow/Remove(mob/living/carbon/M, special = FALSE, drop_if_replaced = TRUE)
	terminate_effects()
	. = ..()
