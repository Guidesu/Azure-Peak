...
/obj/item/reagent_containers/glass/bottle/alchemical/tripot
	...
	desc = "The fruits of your labor, distilled into a sparkling pittance that shimmers with highland light. Sipping this \
...
/atom/movable/screen/alert/status_effect/buff/alch/tripot
	name = "Triumphance"
	desc = "My latest triumph has empowered me! I am a true champion of the outpost!"
	icon_state = "triumph"
