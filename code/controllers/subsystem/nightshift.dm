...
/datum/controller/subsystem/nightshift/proc/process_sunscorch()
	...
	if(!SSticker.sunscorch_burn_warning_sent)
		...
		to_chat(world, span_userdanger("THE WORM CONSUMES THE SUN. Deadly radiance falls on the outpost. Those outside will be unmade. The back of my amygdala itches."))
