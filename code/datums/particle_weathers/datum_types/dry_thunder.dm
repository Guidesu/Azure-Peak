...
/datum/particle_weather/dry_thunderstorm
	...
	desc = "Lightning cracks across a clear sky, unaccompanied by rain."
	particleEffectType = /particles/weather/static_spark
	warning_message = span_greenannounce("Dark clouds roll across the sky, echoes of thunder rumbling across the dry realm.")
