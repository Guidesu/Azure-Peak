...
// Hotsprings
#define DETAIL_TEXT_EORAN_SHRINE "A shrine to Miluše, nestled high in the mountains, hidden away from well-trodden paths. Cherry blossom, a symbol of both love and the fleeting nature of lyfe, are planted and maintained here by her devotees.\n\
