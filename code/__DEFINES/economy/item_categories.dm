...
#define ITEM_CAT_TOOLS_ROGUE "Tools (Rogue & Lockpicks)"
...
#define ITEM_CAT_TROPHY "Trophies"
#define ITEM_CAT_SALVAGE "Salvage & Byproducts"
#define ITEM_CAT_LIVESTOCK "Livestock"

#define ITEM_CAT_RAW_MATERIAL_MINERAL "Raw Materials (Mineral)"
#define ITEM_CAT_RAW_MATERIAL_ORGANIC "Raw Materials (Organic)"
