...
#define is_baotha_amulet(amulet_type) (amulet_type in typesof(/obj/item/clothing/neck/roguetown/psicross/hausvette))
...
// No lamia species exists; this is ported from Ratwood for sexcon tail actions
