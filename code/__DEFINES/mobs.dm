...
//time of day bitflags for mobs (temperature system map/ToD modifiers)
...
#define SKIN_COLOR_WHISPERINGGROVE "edc6b3"
...
#define SKIN_COLOR_GIZA_AMBER "fcccb3"
...
#define SKIN_COLOR_SHALVINE_AMBER "ac8369"
