...
#define THREAT_APEX 70       // Half-drakkyn, ancient dreamfiend — a hunt in itself, not an encounter
#define THREAT_LEGENDARY 100 // Drakkyn broodmother — the thing a whole town turns out for
