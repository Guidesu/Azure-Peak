...
/proc/blood_toll_score_grade(per_capita)
	...
	if(per_capita < BLOOD_TOLL_THRESHOLD_C)
		return list("grade" = "D", "copy" = "THE OUTPOST HAS FALLEN", "color" = "#bd1717")
	if(per_capita < BLOOD_TOLL_THRESHOLD_B)
		return list("grade" = "C", "copy" = "THE OUTPOST STUMBLES", "color" = "#c87a3a")
	if(per_capita < BLOOD_TOLL_THRESHOLD_A)
		return list("grade" = "B", "copy" = "THE OUTPOST STANDS FAST", "color" = "#c4b454")
	if(per_capita < BLOOD_TOLL_THRESHOLD_S)
		return list("grade" = "A", "copy" = "THE OUTPOST TRIUMPHS", "color" = "#7ec46a")
	return list("grade" = "S", "copy" = "THE OUTPOST CAME, SAW AND CONQUERED", "color" = "#e6c060")
