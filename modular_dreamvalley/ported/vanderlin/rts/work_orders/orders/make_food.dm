// Ported from Vanderlin (OpenKeep): code/datums/rts/work_orders/orders/make_food.dm
// Direct port. /datum/food_item is an RTS-internal recipe datum defined in
// building_node/kitchen.dm (ported alongside that file) - not this repo's
// actual nutrition/food-item system, purely a stockpile-economy recipe
// record (name/stamina_restore/requirements), so no naming collision.
