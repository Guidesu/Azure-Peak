// Ported from Vanderlin (OpenKeep): code/datums/rts/work_orders/orders/construct_building.dm
// Ported now (Phase 2) alongside break_turf.dm - see that file's header comment.
