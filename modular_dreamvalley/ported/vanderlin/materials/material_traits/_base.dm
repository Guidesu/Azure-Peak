// Ported from Vanderlin (OpenKeep): code/datums/materials/material_traits/_base.dm
// Self-contained trait registry/framework. Ported as-is; GLOB.material_traits and
// generate_material_traits() have no naming collisions anywhere in this codebase.
