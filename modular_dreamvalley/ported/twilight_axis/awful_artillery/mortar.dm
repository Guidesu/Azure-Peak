// Ported from Twilight-Axis's awful_artillery/code/mortar.dm. The mortar
// subtype of the base artillery structure (steep-angle indirect fire), plus
// its shell (punches through floors/openspace before detonating) and its
// craftable carriage/wheel/barrel parts. All player-facing text translated
...
/obj/item/artillery_shell/shell_action()
	...
	playsound(src, 'modular_dreamvalley/sound/twilight_artillery/fallingonyou.ogg', 100, 0, 10, 1, null, null, FALSE, TRUE)
	sleep(0.5 SECONDS)

	for(var/mob/M in GLOB.player_list)
		M.playsound_local(src, 'modular_dreamvalley/sound/twilight_artillery/far_explosion.ogg', 100, FALSE, pressure_affected = FALSE)
...
/obj/structure/artillery/mortar
	name = "mortar"
	desc = "A heavy indirect-fire weapon meant for lobbing shells over walls and fortifications. \
		Fires on a steep arc, relying on gunpowder and the gunner's judgement rather than a direct line of sight."
...
/obj/item/mortar_used_barrel
	...
	desc = "If reforged in a furnace, the barrel could be partially restored."
	icon = 'modular_dreamvalley/icons/twilight_artillery/artillery.dmi'
	icon_state = "barrel"
	color = "#ecaf86"
	sellprice = 25
