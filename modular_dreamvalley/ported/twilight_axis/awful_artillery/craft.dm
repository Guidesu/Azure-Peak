// Ported from Twilight-Axis's awful_artillery/code/craft.dm. Carpentry
// crafting-table recipes for the mortar's wheels/carriage/final assembly,
// plus anvil recipes for forging its barrel. Comment translated from Russian.
...
///////////////////////////////////////////////////////////////////////
/// Artificer filler recipe.
/// Effectively a placebo (buying from the merchant is easier), but
/// players asked for a crafting path to exist anyway.
//////////////////////////////////////////////////////////////////////
/obj/item/artillery_barrel_assembly
	name = "artillery barrel blank"
	desc = "Can be specialized into a particular piece of artillery."
...
/obj/item/mortar_barrel_assembly
	...
	desc = "A careful polish and it'll be ready."
	icon = 'modular_dreamvalley/icons/twilight_artillery/artillery.dmi'
	icon_state = "barrel"
	color = "#96745e"
