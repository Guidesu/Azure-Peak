...
// Workstation names translated from Russian.

/datum/workstation
	var/workstation_name = "Plot"
...
/datum/workstation/cathedral
	workstation_name = "Church of the All-Father"
