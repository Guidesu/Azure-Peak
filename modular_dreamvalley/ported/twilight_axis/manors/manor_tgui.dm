...
// Window title and fallback strings translated from Russian.
...
/datum/manor_panel/ui_interact(mob/user, datum/tgui/ui)
	...
	if(!ui)
		ui = new(user, src, "ManorPanel", "Estate")
		ui.open()

/datum/asset/simple/manor
	assets = list(
		"field_icon.png" = 'modular_dreamvalley/icons/manors/field_icon.png',
		"fishing_icon.png" = 'modular_dreamvalley/icons/manors/fishing_icon.png',
		"forest_icon.png" = 'modular_dreamvalley/icons/manors/forest_icon.png',
		"fruit_icon.png" = 'modular_dreamvalley/icons/manors/fruit_icon.png',
		"hunting_icon.png" = 'modular_dreamvalley/icons/manors/hunting_icon.png',
		"ranch_icon.png" = 'modular_dreamvalley/icons/manors/ranch_icon.png',
		"trade_icon.png" = 'modular_dreamvalley/icons/manors/trade_icon.png',
		"mine_icon.png" = 'modular_dreamvalley/icons/manors/mine_icon.png',
		"mage_tower_icon.png" = 'modular_dreamvalley/icons/manors/mage_tower_icon.png',
		"cathedral_icon.png" = 'modular_dreamvalley/icons/manors/cathedral_icon.png',
		"outpost_icon.png" = 'modular_dreamvalley/icons/manors/outpost_icon.png',
	)
...
/datum/manor_panel/ui_data(mob/user)
	...
	if(!manor)
		return list(
			"manor_name" = "No estate available",
			"manor_type" = "manor",
	...
	if(manor.virtue_origin)
		origin = manor.virtue_origin.name
