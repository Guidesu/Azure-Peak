...
// player-facing text translated from Russian into English. Ammo pouches
// (bullet bags, cannonball/grapeshot bags, and the rune-recalling pharetra).
// Also defines /obj/effect/temp_visual/small_smoke/gunsmoke, a small cosmetic
// puff used by the runelock pistol on firing (this repo's small_smoke base
// class exists but had no gunsmoke-flavored subtype).

/obj/effect/temp_visual/small_smoke/gunsmoke

/obj/item/quiver/twilight_bullet
	name = "ammo bag"
	desc = "A small pouch for storing bullets for a firearm."
...
/obj/item/quiver/twilight_bullet/cannonball
	name = "cannonball bag"
	desc = "A small pouch for storing cannonballs and grapeshot."
	icon_state = "cpouch1"
	item_state = "cpouch1"
...
/obj/item/quiver/twilight_bullet/runicbag
	name = "pharetra"
	desc = "A leather pouch meant for storing runed bullets. A rune etched onto the metal of the lock binds itself to the ammunition stored inside, and when activated, recalls already-fired runed bullets back into storage for reuse."
	icon_state = "runebag"
	item_state = "runebag"
	max_storage = 6
