// Ported from Twilight-Axis's firearms/code/jobs/gunslinger.dm. Attaches
// automatically to the base Mercenary job via CTAG_MERCENARY category roll
// (see /datum/job/roguetown/mercenary's advclass_cat_rolls) — no explicit
// job_subclasses list edit needed.
...
/datum/advclass/mercenary/twilight_gunslinger
	...
	cmode_music = 'modular_dreamvalley/sound/twilight_firearms/music/combat_gunslinger.ogg'
