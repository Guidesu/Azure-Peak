// Ported from Twilight-Axis's firearms/code/jobs/blackpowder_hunter.dm.
// Attaches automatically to the base Adventurer job via CTAG_ADVENTURER
// category roll. Both archetype dialogue lines translated from Russian.
...
/datum/outfit/job/roguetown/adventurer/twilight_hunter/pre_equip(mob/living/carbon/human/H)
	...
	switch(class_choice)
		...
		if("Peasant")
			to_chat(H, span_purple("'..Well now... you've chosen to be a simple hunter. You've got good potential for the future!..'"))
