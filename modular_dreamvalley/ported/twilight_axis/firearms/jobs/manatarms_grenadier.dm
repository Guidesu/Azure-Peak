// Ported from Twilight-Axis's firearms/code/jobs/manatarms_grenadier.dm.
// Attaches to the base Men-at-Arms (manorguard) job via CTAG_MENATARMS
// category roll. Weapon-choice dialogue translated from Russian.
...
/datum/outfit/job/roguetown/manorguard/twilight_grenadier/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		var/weapons = list("Bayonet Arquebus","Culverin and Grapeshot")
		var/weapon_choice = input("Choose your weapon.", "TO ARMS") as anything in weapons
		H.set_blindness(0)
