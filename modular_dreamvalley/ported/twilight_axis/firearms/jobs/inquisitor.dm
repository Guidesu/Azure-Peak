// Ported from Twilight-Axis's firearms/code/jobs/inquisitor.dm. The new
// "Blackpowder Réprimer" advclass attaches automatically to the base
// Inquisitor job via CTAG_INQUSITOR category roll.
