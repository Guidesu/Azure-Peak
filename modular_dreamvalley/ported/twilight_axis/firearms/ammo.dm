...
// player-facing text translated from Russian into English. Ammunition,
// ammo pouches, gunpowder status effects, and the twilight_firearm/
// twilight_runelock-specific projectile hit logic.
...
/obj/projectile/bullet/twilight_lead
	name = "lead sphere"
	desc = "A small lead sphere. Pairs well with gunpowder."
	damage = 120
	damage_type = BRUTE
	icon = 'modular_dreamvalley/icons/twilight_firearms/ammo.dmi'
...
/obj/projectile/bullet/twilight_lead/silver
	name = "silver sphere"
	desc = "A small silver sphere. Softer than a lead ball, but extremely effective against the undead."
...
/obj/projectile/bullet/twilight_cannonball
	name = "cannonball"
	desc = "A large lead sphere. It is not the size of the barrel that matters, but the size of the hole it makes in your enemy."
	damage = 150
	damage_type = BRUTE
	icon = 'modular_dreamvalley/icons/twilight_firearms/ammo.dmi'
	icon_state = "musketball_proj"
...
/obj/projectile/bullet/twilight_grapeshot
	name = "grapeshot"
	desc = "A paper-wrapped bundle of small metal balls. Pairs well with gunpowder."
	damage = 30
	damage_type = BRUTE
	icon = 'modular_dreamvalley/icons/twilight_firearms/ammo.dmi'
	icon_state = "musketball_proj"
...
/obj/projectile/bullet/twilight_lead/twilight_runelock
	name = "runed sphere"
	desc = "A small, perfectly round metal ball, etched with Psaidonite runes. Lethal at high speed."
	damage = 90
	speed = 0.6
	damage_type = BRUTE
	icon = 'modular_dreamvalley/icons/twilight_firearms/ammo.dmi'
...
/obj/projectile/bullet/twilight_lead/twilight_runelock/blessed
	name = "blessed sphere"
	desc = "A small, perfectly round ball made of pure silver. Such ammunition is forged by the finest Otavan smiths and personally consecrated by the Grand Master. Lethal against the undead, but quite effective against other heretics too."
	damage = 100
...
/obj/item/ammo_casing/caseless/rogue/twilight_lead/runelock/equipped(mob/living/user)
	if(ishuman(user))
		...
		if(!HAS_TRAIT(H, TRAIT_INQUISITION) && !(H.STAINT >= 15) && !(H.patron?.type == /datum/patron/tribunal/praecursor) && !(H.merctype == 10))
