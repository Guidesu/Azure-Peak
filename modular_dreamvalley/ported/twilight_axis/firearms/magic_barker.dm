...
/obj/item/gun/ballistic/twilight_firearm/barker/barker_staff/toper
	...
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barker_toper.dmi'
...
/obj/item/gun/ballistic/twilight_firearm/barker/barker_staff/gemerald
	...
	desc = "An amber focus-gem hewn by pressure immense sits nestled in metal of this weapon."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barker_gemerald.dmi'
...
/obj/item/gun/ballistic/twilight_firearm/barker/barker_staff/sapphire
	...
	desc = "An amber focus-gem hewn by pressure immense sits nestled in metal of this weapon."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barker_sapphire.dmi'
...
/obj/item/gun/ballistic/twilight_firearm/barker/barker_staff/rontz
	...
	desc = "An amber focus-gem hewn by pressure immense sits nestled in metal of this weapon."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barker_rontz.dmi'
...
/obj/item/gun/ballistic/twilight_firearm/barker/barker_staff/amethyst
	...
	desc = "An amber focus-gem hewn by pressure immense sits nestled in metal of this weapon."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barker_amethyst.dmi'
...
/obj/item/gun/ballistic/twilight_firearm/barker/barker_light/dendor1
	...
	desc = "One of the earliest firearms, made by Otavan craftsmen at the start of the century before last. This one has grown a layer of bone and hide, like a druid's staff, giving it a bit more durability."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/dendor1.dmi'
	icon_state = "dendor1"
	item_state = "dendor1"
	wdefense = 4
	max_integrity = 200
...
/obj/item/gun/ballistic/twilight_firearm/barker/barker_light/dendor2
	name = "guiding light"
	desc = "A battered weapon that has clearly seen enough in its lifetime, having since become a vessel for a fragment of a mad god, whose glow now guides its owner."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/dendor2.dmi'
	icon_state = "dendor2"
	item_state = "dendor2"
	light_color = "#57c179"
	light_outer_range = 5
...
/obj/item/gun/ballistic/twilight_firearm/barker/arti_barker1
	name = "ignited barker"
	desc = "One of the earliest firearms, made by Otavan craftsmen at the start of the century before last. This example is fitted with a rotating handle holding a smoldering ember, which lights the fuse for you."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barti.dmi'
	icon_state = "barti"
	item_state = "barti"
	match_delay = 1
...
/obj/item/gun/ballistic/twilight_firearm/barker/arti_barker2
	...
	desc = "A twisted variant of one of the earliest firearms, meant for hunters who leap across high slopes."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barti1.dmi'
	icon_state = "barti2"
	item_state = "barti2"
	slot_flags = NONE
	match_delay = 1
...
/obj/item/gun/ballistic/twilight_firearm/barker/arti_barker3
	...
	desc = "An old staff that can spit fire at game and serve as a sturdy pole for climbing up and down whole mountains."
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/barti2.dmi'
	icon_state = "barti3"
	item_state = "barti3"
	slot_flags = NONE
	match_delay = 1
...
/obj/item/sharpener/ignited
	...
	icon = 'modular_dreamvalley/icons/twilight_firearms/magic/bstuff.dmi'
	icon_state = "istone"
