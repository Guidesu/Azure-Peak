...
/datum/mapGeneratorModule/jungle
	...
	allowed_turfs = list(/turf/open/floor/rogue/dirt, /turf/open/floor/rogue/dirt/desert, /turf/open/floor/rogue/desert_grass, /turf/open/floor/rogue/grass, /turf/open/floor/rogue/grassred, /turf/open/floor/rogue/grassyel, /turf/open/floor/rogue/grasscold)
	...
	spawnableAtoms = list(/obj/structure/flora/roguetree/palm = 4,
							...
							/obj/structure/glowshroom/dendorite = 0.15,
							/obj/structure/flora/ausbushes/ppflowers = 0.4,
							/obj/structure/flora/ausbushes/ywflowers = 0.3,
							/obj/structure/flora/ausbushes/brflowers = 0.3,
							/obj/structure/flora/junglebush = 3,
							/obj/structure/flora/junglebush/large = 0.8,
							...
							/obj/structure/flora/rogueshroom/unhappy/random = 0.5,
							/obj/structure/flora/rogueshroom/unhappy/angel = 0.1,
							/obj/structure/flora/mushroomcluster = 1.5,
